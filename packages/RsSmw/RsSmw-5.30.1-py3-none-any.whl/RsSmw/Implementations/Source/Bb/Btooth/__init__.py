...
class BtoothCls:
	"""Btooth commands group definition. 326 total commands, 21 Subgroups, 18 group commands"""
	...
	@property
	def cs(self):
		"""cs commands group. 3 Sub-classes, 19 commands."""
	...
	def get_ctype(self) -> enums.BtoChnnelType:
		...
		Determines the channel type. Advertising and data are available. \n
			:return: ctype: ADVertising| DATA| CS ADVertising Selects channel type advertising. DATA Selects channel type data. Devices in a connected state transmit data channel packets in connection events with a start point and an interval.
		"""
	...
	def set_ctype(self, ctype: enums.BtoChnnelType) -> None:
		...
		Determines the channel type. Advertising and data are available. \n
			:param ctype: ADVertising| DATA| CS ADVertising Selects channel type advertising. DATA Selects channel type data. Devices in a connected state transmit data channel packets in connection events with a start point and an interval.
		"""
	...
	def get_up_type(self) -> enums.BtoUlpPckType:
		...
		R&S SMW-K178 packet/PDU types
			Table Header: <UpType> / Packet/PDU type \n
			- CSSEq / CS_SEQUENCE \n
			:return: up_type: AIND| ADINd| ANINd| SREQ| SRSP| CREQ| ADCind| DATA| CUReq| CMReq| TIND| EREQ| ERSP| SEReq| SERSp| URSP| FREQ| FRSP| TPACket| PEReq| PERSp| VIND| RIND| PREQ| PRSP| PUIN| LREQ| LRSP| SFR| CPR| CPRS| REIN| PIR| PIRS| AEINd| AAINd| ACINd| ASINd| ASReq| ASPSp| ACRSp| ACReq| MUCH| CONT| CTEQ| CTEP| PSINd| CAReq| CARSp| CSSEQ
		"""
	...
	def set_up_type(self, up_type: enums.BtoUlpPckType) -> None:
		...
		R&S SMW-K178 packet/PDU types
			Table Header: <UpType> / Packet/PDU type \n
			- CSSEq / CS_SEQUENCE \n
			:param up_type: AIND| ADINd| ANINd| SREQ| SRSP| CREQ| ADCind| DATA| CUReq| CMReq| TIND| EREQ| ERSP| SEReq| SERSp| URSP| FREQ| FRSP| TPACket| PEReq| PERSp| VIND| RIND| PREQ| PRSP| PUIN| LREQ| LRSP| SFR| CPR| CPRS| REIN| PIR| PIRS| AEINd| AAINd| ACINd| ASINd| ASReq| ASPSp| ACRSp| ACReq| MUCH| CONT| CTEQ| CTEP| PSINd| CAReq| CARSp| CSSEQ
		"""
