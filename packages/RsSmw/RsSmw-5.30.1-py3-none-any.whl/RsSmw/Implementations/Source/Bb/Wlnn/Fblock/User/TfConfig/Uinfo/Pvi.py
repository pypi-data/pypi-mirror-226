...
class PviCls:
	...
	def set(self, phy_ver_id: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default, triggerFrameUser=repcap.TriggerFrameUser.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.tfConfig.uinfo.pvi.set(phy_ver_id = ['raw1', 'raw2', 'raw3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default, triggerFrameUser = repcap.TriggerFrameUser.Default) \n
