...
class Ps160Cls:
	...
	def set(self, ps_160: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default, triggerFrameUser=repcap.TriggerFrameUser.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.tfConfig.uinfo.ps160.set(ps_160 = ['raw1', 'raw2', 'raw3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default, triggerFrameUser = repcap.TriggerFrameUser.Default) \n
