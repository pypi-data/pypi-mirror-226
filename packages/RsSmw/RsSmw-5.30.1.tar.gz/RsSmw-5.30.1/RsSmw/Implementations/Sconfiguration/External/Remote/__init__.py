...
class RemoteCls:
	...
	def delete(self, id_pi_db_ext_dev_rem_inst_remove: List[str]) -> None:
		...
		Snippet: driver.sconfiguration.external.remote.delete(id_pi_db_ext_dev_rem_inst_remove = ['1', '2', '3']) \n
	...
	def set_rename(self, id_pi_db_rem_inst_rename: List[str]) -> None:
		...
		Snippet: driver.sconfiguration.external.remote.set_rename(id_pi_db_rem_inst_rename = ['1', '2', '3']) \n
