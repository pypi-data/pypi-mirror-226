...
class SbitsCls:
	...
	def set(self, pattern: List[str], bitcount: int, cellNull=repcap.CellNull.Default, indexNull=repcap.IndexNull.Default) -> None:
		...
		Snippet: driver.source.bb.nr5G.node.cell.sspbch.sl.sbits.set(pattern = ['raw1', 'raw2', 'raw3'], bitcount = 1, cellNull = repcap.CellNull.Default, indexNull = repcap.IndexNull.Default) \n
