...
class EsCls:
	...
	def get_rb_config(self) -> enums.Config:
		...
		Sets the configuration mode for the resource block configuration. \n
			:return: qck_set_rb_config: MAN| EFL| EFR| E1RL| E1RR| OUTF| INNF| I1RL| I1RR| OUTP| O1RL| O1RR| R1IF| R1IL| R1IR| R2IF| R2IL| R2IR
		"""
	...
	def set_rb_config(self, qck_set_rb_config: enums.Config) -> None:
		...
		Sets the configuration mode for the resource block configuration. \n
			:param qck_set_rb_config: MAN| EFL| EFR| E1RL| E1RR| OUTF| INNF| I1RL| I1RR| OUTP| O1RL| O1RR| R1IF| R1IL| R1IR| R2IF| R2IL| R2IR
		"""
