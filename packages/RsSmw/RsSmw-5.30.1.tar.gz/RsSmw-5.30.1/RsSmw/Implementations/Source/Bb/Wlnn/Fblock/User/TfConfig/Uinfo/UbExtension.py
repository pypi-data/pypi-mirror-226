...
class UbExtensionCls:
	...
	def set(self, ul_band_ext: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default, triggerFrameUser=repcap.TriggerFrameUser.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.tfConfig.uinfo.ubExtension.set(ul_band_ext = ['raw1', 'raw2', 'raw3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default, triggerFrameUser = repcap.TriggerFrameUser.Default) \n
