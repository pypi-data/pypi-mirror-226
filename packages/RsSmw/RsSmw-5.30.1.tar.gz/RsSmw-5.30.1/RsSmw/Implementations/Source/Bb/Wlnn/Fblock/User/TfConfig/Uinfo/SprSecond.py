...
class SprSecondCls:
	...
	def set(self, spatial_reuse_2: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default, triggerFrameUser=repcap.TriggerFrameUser.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.tfConfig.uinfo.sprSecond.set(spatial_reuse_2 = ['raw1', 'raw2', 'raw3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default, triggerFrameUser = repcap.TriggerFrameUser.Default) \n
