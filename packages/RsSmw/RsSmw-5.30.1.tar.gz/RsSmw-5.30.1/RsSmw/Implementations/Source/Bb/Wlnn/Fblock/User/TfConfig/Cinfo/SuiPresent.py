...
class SuiPresentCls:
	...
	def set(self, spe_user_info_pres: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.tfConfig.cinfo.suiPresent.set(spe_user_info_pres = ['raw1', 'raw2', 'raw3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default) \n
