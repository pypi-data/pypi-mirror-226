...
def simupage_2D():
    ...
    spatial_label = tk.Label(simu_frame, text="Spatial", fg="#7B1FA2", font=georgia_font)
    spatial_label.place(relx=0.1, rely=0.08, anchor="w")
    temporal_label = tk.Label(simu_frame, text="Temporal", fg="#7B1FA2", font=georgia_font)
    temporal_label.place(relx=0.73, rely=0.08, anchor="w")
    
    sigmaU_label = tk.Label(left_column, text="sigmaU", fg="blue")
    sigmaU_label.place(relx=0.1, rely=0.095, anchor="w")
    
    sigmaD_label = tk.Label(left_column, text="sigmaD", fg="red")
    sigmaD_label.place(relx=0.1, rely=0.22, anchor="w")
    
    sigmaZ_label = tk.Label(left_column, text="sigmaZ", fg="black")
    sigmaZ_label.place(relx=0.1, rely=0.345, anchor="w")
    
    mup_label = tk.Label(left_column, text="Z_center", fg="black")
    mup_label.place(relx=0.1, rely=0.47, anchor="w")
    
    sti1_label = tk.Label(left_column, text="stimulusU", fg="blue")
    sti1_label.place(relx=0.08, rely=0.595, anchor="w")
    
    sti2_label = tk.Label(left_column, text="stimulusD", fg="red")
    ...
    sigmaU_label = tk.Label(right_column, text="sigmaU", fg="blue")
    sigmaU_label.place(relx=0.1, rely=0.095, anchor="w")
    
    sigmaD_label = tk.Label(right_column, text="sigmaD", fg="red")
    sigmaD_label.place(relx=0.1, rely=0.22, anchor="w")
    
    sigmaZ_label = tk.Label(right_column, text="sigmaZ", fg="black")
    sigmaZ_label.place(relx=0.1, rely=0.345, anchor="w")
    
    mup_label = tk.Label(right_column, text="Z_center", fg="black")
    mup_label.place(relx=0.1, rely=0.47, anchor="w")
    
    sti1_label = tk.Label(right_column, text="stimulusU", fg="blue")
    sti1_label.place(relx=0.08, rely=0.595, anchor="w")
    
    sti2_label = tk.Label(right_column, text="stimulusD", fg="red")
    sti2_label.place(relx=0.08, rely=0.72, anchor="w")
    ...
    button_disp.place(relx=0.91, rely=0.86, anchor="e")  
    ...
    check_button_a_simu.place(relx=0.2, rely=0.82, anchor="e")
    check_button_b_simu.place(relx=0.53, rely=0.82, anchor="e")
    check_button_c_simu.place(relx=0.86, rely=0.82, anchor="e")       
    # Back
...
def open_welcome():
    ...
    version_label = tk.Label(window, text="Version 0.0.1.7", fg="gray")
    ...
    startSim_button = tk.Button(welcome_frame, text="Simulating for 1-D Continuous Condition", command=lambda: simu_page(1))
    startSim_button.place(relx=0.5, rely=0.5, anchor="center")

    startSim2D_button = tk.Button(welcome_frame, text="Simulating for 2-D Continuous Condition", command=simupage_2D)
    startSim2D_button.place(relx=0.5, rely=0.55, anchor="center")

    startSimall_button = tk.Button(welcome_frame, text="Simulating for Numerosity Task", command=lambda: simu_page(2))
    startSimall_button.place(relx=0.5, rely=0.6, anchor="center")
