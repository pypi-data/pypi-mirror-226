...
def main():
    parser = argparse.ArgumentParser(description='Arabic text stripping tool')
    
    # Adding arguments
    parser.add_argument('--text', type=str, required=True, help='Arabic text to be stripped')
    ...
    stripped_text = arStrip(args.text, diacs=args.diacs, smallDiacs=args.smallDiacs, shaddah=args.shaddah, 
                            digit=args.digit, alif=args.alif, specialChars=args.specialChars)
