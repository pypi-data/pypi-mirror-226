...
def main():
    parser = argparse.ArgumentParser(description='Normalize Arabic words')
    
    # Adding arguments
    parser.add_argument('--word', type=str, required=True, help='Arabic word to be normalized')
    parser.add_argument('--ignore_all_diacritics_but_not_shadda', type=bool, default=True, help='Whether to ignore all diacritics except shadda')
    parser.add_argument('--ignore_shadda_diacritic', type=bool, default=True, help='Whether to ignore shadda diacritic')

    args = parser.parse_args()

    normalized_word = normalize_word(args.word, ignore_all_diacritics_but_not_shadda=args.ignore_all_diacritics_but_not_shadda, 
                                     ignore_shadda_diacritic=args.ignore_shadda_diacritic)
