...
from johnsnowlabs.utils.enums import LatestCompatibleProductVersion, ProductName
...
def check_and_install_dependencies(
    ...
    while (
        ...
        install_results[v] = v.install(
            ...
            re_install=(
                settings.enforce_versions and v.check_installed_correct_version()
            ),
        )
    if offline_zip_dir:
    ...
    if len(install_results) > 0:
        ...
        from johnsnowlabs import finance, legal, medical, nlp, visual
