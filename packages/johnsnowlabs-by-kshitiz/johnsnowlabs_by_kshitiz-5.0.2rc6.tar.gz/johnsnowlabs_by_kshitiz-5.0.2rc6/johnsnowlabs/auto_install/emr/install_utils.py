                    ...
                    "Configurations": [
                        {
                            ...
                            "Properties": {
                                ...
                                "PYSPARK_PYTHON": "/lib/.johnsnowlabs/bin/python3",
                                "JSL_EMR": "1",
                            },
                        }
                    ],
...
export JSL_EMR=1
echo -e 'export PYSPARK_PYTHON=/lib/.johnsnowlabs/bin/python3 
export HADOOP_CONF_DIR=/etc/hadoop/conf 
export SPARK_JARS_DIR=/usr/lib/spark/jars 
export SPARK_HOME=/usr/lib/spark' >> $HOME/.bashrc && source $HOME/.bashrc
sudo python3 -m venv /lib/.johnsnowlabs
sudo /lib/.johnsnowlabs/bin/pip install {Software.jsl_lib.pypi_name}=={settings.raw_version_jsl_lib}
...
"""
    installation_script = ""
    if license:
        installation_script += f"sudo -E /lib/.johnsnowlabs/bin/python3 -c \"from johnsnowlabs import nlp;nlp.install(med_license='{secrets.HC_LICENSE or ''}',aws_access_key='{secrets.AWS_ACCESS_KEY_ID or ''}',aws_key_id='{secrets.AWS_SECRET_ACCESS_KEY or ''}', spark_nlp={spark_nlp}, nlp={nlp}, visual={visual}, hardware_platform='{hardware_platform}')\""
    else:
        installation_script += f"sudo -E /lib/.johnsnowlabs/bin/python3 -c \"from johnsnowlabs import nlp;nlp.install(browser_login=False, nlp=False, hardware_platform='{hardware_platform}')\""
