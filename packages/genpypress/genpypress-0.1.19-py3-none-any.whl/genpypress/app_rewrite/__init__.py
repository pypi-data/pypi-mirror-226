    ...
    sample = textwrap.dedent(
        ...
        [
            { 
                ...
                #        zpětná lomítka (na loítka) - a pokud název souboru KONČÍ
                #        na text uvedený ve where, v souboru se provedou replacementy
                "where": "ppfb_cust_dn1\trf\dm01_ppfb_cust_dn1.sql",
            ...
            { 
                "where": "ppfb_cust_dn1\trf\another_file.sql",
                "rules": [
                    { 
                        "old_val" : "old",
                        "new_val" : "new"
