...
def rewrite(directory: str = ".", config_file_name: str = "rewrite.json", max_files=20, run_press=True):
    """
...
def ddl_to_async(
    ...
    """
    _app_to_async.to_async(folder=folder, max_files=max_files, encoding=encoding)
