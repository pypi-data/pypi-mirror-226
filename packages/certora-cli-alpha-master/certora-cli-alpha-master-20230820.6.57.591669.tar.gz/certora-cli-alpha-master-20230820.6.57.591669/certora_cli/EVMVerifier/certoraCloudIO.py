...
class CloudVerification:
    ...
    def _set_url(self, url_attr: str, index: str, user_id: int, anonymousKey: str,
    ...
    def _send_verification_request(self, cl_args: str) -> bool:
        """
    ...
    def _compress_and_upload_zip_files(self) -> bool:
        """
    ...
    def cli_verify_and_report(self, cl_args: str, send_only: bool = False) -> bool:
        ...
        post_result = self._send_verification_request(cl_args)
        if not post_result:
            return False

        file_upload_success = self._compress_and_upload_zip_files()
