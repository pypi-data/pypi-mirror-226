...
def _validate_enum_value(string: str, enum_class: Type[Enum]) -> str:
...
def validate_sanity_value(value: str) -> str:
    return _validate_enum_value(value, RuleSanityValue)


def validate_test_value(value: str) -> str:
    return _validate_enum_value(value, Util.TestValue)


def validate_fe_value(value: str) -> str:
    return _validate_enum_value(value, Util.FeValue)
...
def validate_run_source(string: str) -> str:
    ...
    """
    return _validate_enum_value(string, RunSources).upper()


def validate_multi_example_value(value: str) -> str:
    return _validate_enum_value(value, MultiExampleValue)
...
def validate_false(value: str) -> str:
    ...
    the value 'false'.
    '''
    return _validate_enum_value(value, FalseValue)


def validate_on_off(value: str) -> str:
    return _validate_enum_value(value, OnOffValue)
