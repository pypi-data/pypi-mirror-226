...
class FotoMenfes:
    async def add_foto_boy(self: "kymang.Client", foto_boy):
    ...
    async def del_foto_boy(self: "kymang.Client", foto_boy):
        hastagdb = self.mongo_async.foto_boy
        await hastagdb.delete_one({"bot_id": self.me.id, "foto_boy": foto_boy})


    async def get_foto_boy(self: "kymang.Client"):
        hastagdb = self.mongo_async.foto_boy
    ...
    async def add_foto_girl(self: "kymang.Client", foto_girl):
    ...
    async def del_foto_boy(self: "kymang.Client", foto_girl):
        hastagdb = self.mongo_async.foto_girl
