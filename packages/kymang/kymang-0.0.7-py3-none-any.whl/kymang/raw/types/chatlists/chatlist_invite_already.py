...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <kymang.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <kymang.raw.base.Peer>`):
            N/A
