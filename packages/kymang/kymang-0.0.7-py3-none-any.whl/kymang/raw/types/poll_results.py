...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <kymang.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <kymang.raw.base.MessageEntity>`, *optional*):
            N/A
