...
class InputBotInlineMessageMediaInvoice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.InputBotInlineMessage`.
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <kymang.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <kymang.raw.base.InputWebDocument>`, *optional*):
            N/A
