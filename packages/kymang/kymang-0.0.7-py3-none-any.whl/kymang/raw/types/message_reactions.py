...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <kymang.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <kymang.raw.base.MessagePeerReaction>`, *optional*):
            N/A
