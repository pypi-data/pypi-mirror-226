...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <kymang.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <kymang.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <kymang.raw.base.account.EmailVerified>`
    """
