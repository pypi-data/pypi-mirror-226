...
class First:
    ...
    REPO = """
**Hey**, __I am Robot__ ⭐ **UbotPyro-Bot** ⭐

⭐ **Userbot Version :** `{}`
⭐ **Group Support :** [Support Group](t.me/kynansupport)
⭐ **Owner Repo :** [Mazi](t.me/kenapatagdar)
⭐ **Repo :** [UbotPyro-Bot](https://github.com/darmazi)
...
DEPLOY [VIA HEROKU](https://telegram.dog/XTZ_HerokuBot?start=cmFtYWRoYW5pODkyL1JhbVB5cm8tQm90IGRyYWdvbnM)"""
    CREATOR = 'I was created by my master <a href="https://github.com/Mazidhani892/UbotPyro-Bot">Ubot</a> on a rainy day.'
    MSG_ON = """
⭐ **UbotPyro-Bot Menyala** ⭐
━━
➠ **Userbot Version -** `{}`
➠ **Ketik** `{}Mazi` **untuk Mengecheck Bot**
━━
"""
