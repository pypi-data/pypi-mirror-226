...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~kymang.types.InputMediaPhoto`, :obj:`~kymang.types.InputMediaVideo`, :obj:`~kymang.types.InputMediaAudio` and :obj:`~kymang.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~kymang.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from kymang.types import InputMediaPhoto, InputMediaVideo
