...
from kymang.errors import AuthBytesInvalid
from kymang.session import Session
from kymang.session.auth import Auth


async def get_session(client: "kymang.Client", dc_id: int):
