...
class GetParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`ChannelParticipantsFilter <kymang.raw.base.ChannelParticipantsFilter>`):
            N/A
    ...
    Returns:
        :obj:`channels.ChannelParticipants <kymang.raw.base.channels.ChannelParticipants>`
    """
