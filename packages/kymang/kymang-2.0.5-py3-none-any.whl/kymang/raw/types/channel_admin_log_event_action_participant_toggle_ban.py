...
class ChannelAdminLogEventActionParticipantToggleBan(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <kymang.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <kymang.raw.base.ChannelParticipant>`):
            N/A
