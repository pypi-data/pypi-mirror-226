...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <kymang.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <kymang.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <kymang.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <kymang.raw.base.updates.State>`):
            N/A
