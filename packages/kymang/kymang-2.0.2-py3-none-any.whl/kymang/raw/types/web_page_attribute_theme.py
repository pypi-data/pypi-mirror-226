...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <kymang.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <kymang.raw.base.ThemeSettings>`, *optional*):
            N/A
