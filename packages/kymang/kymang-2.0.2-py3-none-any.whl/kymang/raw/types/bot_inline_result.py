...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <kymang.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <kymang.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <kymang.raw.base.WebDocument>`, *optional*):
            N/A
