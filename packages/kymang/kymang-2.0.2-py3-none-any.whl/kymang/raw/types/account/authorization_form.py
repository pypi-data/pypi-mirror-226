...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <kymang.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <kymang.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <kymang.raw.base.SecureValueError>`):
            N/A
