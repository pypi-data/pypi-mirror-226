...
with open("kymang/__init__.py", "rt", encoding="utf8") as x:
...
name = "kymang"
author = "Kymang"
author_email = "berliansayang1503@gmail.com"
description = "kymang - Telegram MTProto API Client Library for Python."
url = "https://github.com/kymang/kymang"
project_urls = {
    "Bug Tracker": "https://github.com/kymang/kymang/issues",
    "Documentation": "https://kymang.tech",
    "Source Code": "https://github.com/kymang/kymang",
}
classifiers = [
