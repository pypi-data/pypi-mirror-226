...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~kymang.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~kymang.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~kymang.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "kymang". Get the first 50 results
                async for message in app.search_global("kymang", limit=50):
                    print(message.text)
