...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~kymang.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kymang.Client):
                self.add_handler(kymang.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kymang.handlers.ChatJoinRequestHandler(func, self),
