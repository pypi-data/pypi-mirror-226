...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        ...
        invite_link (:obj:`~kymang.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~kymang.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~kymang.types.ChatJoinRequest`.
