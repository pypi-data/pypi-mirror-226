...
async def compose(
    clients: List["kymang.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``kymang`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~kymang.Client.run`.

    Parameters:
        clients (List of :obj:`~kymang.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from kymang import Client, compose
