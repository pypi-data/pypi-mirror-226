...
from kymang.crypto import aes, rsa, prime
from kymang.errors import SecurityCheckMismatch
from kymang.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "kymang.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
