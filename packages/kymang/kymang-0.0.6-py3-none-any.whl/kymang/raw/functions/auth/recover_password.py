...
class RecoverPassword(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        new_settings (:obj:`account.PasswordInputSettings <kymang.raw.base.account.PasswordInputSettings>`, *optional*):
            N/A

    Returns:
        :obj:`auth.Authorization <kymang.raw.base.auth.Authorization>`
    """
