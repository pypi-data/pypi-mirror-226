...
from kymang.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "kymang.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~kymang.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~kymang.handlers.MessageHandler` the *update* argument will be a :obj:`~kymang.types.Message`; in a :obj:`~kymang.handlers.CallbackQueryHandler` the *update* will be a :obj:`~kymang.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~kymang.filters.command` or :meth:`~kymang.filters.regex`.
    """
    return type(
...
# region me_filter
async def sudo_filter(_, __: "kymang.Client", m: Message):
...
"""Filter messages that contain :obj:`~kymang.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Document` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Game` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Video` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~kymang.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Location` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~kymang.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~kymang.types.Message`.
    ...
    async def func(flt, client: kymang.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~kymang.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~kymang.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~kymang.types.InlineQuery`: The filter will match ``query``.
