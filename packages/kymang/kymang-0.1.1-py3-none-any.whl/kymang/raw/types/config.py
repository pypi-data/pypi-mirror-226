...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <kymang.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <kymang.raw.base.Reaction>`, *optional*):
            N/A
