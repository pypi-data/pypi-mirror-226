...
import kymang
from kymang import StopTransmission, enums
from kymang import raw
from kymang import types
from kymang import utils
from kymang.errors import FilePartMissing
from kymang.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~kymang.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~kymang.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~kymang.Client.stop_transmission`, None is returned.
