...
import kymang
from kymang import __version__, __license__
from kymang import enums
from kymang import raw
from kymang import utils
from kymang.crypto import aes
from kymang.errors import CDNFileHashMismatch
from kymang.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from kymang.handlers.handler import Handler
from kymang.methods import Methods
from kymang.session import Auth, Session
from kymang.storage import FileStorage, MemoryStorage, MongoDB
from kymang.types import User, TermsOfService, ListenerStopped, ListenerTimeout, ListenerTypes
from kymang.utils import ainput, PyromodConfig
...
class Client(Methods):
    """kymang Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        assistant (``bool``, *optional*):
            Pass True if Your using PyTgCalls client.
            Default to False.

        app_version (``str``, *optional*):
            Application version.
            Defaults to "kymang x.y.z".
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~kymang.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where kymang will store the session files.
    ...
    APP_VERSION = f"kymang {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to kymang (version {__version__})")
        print(f"kymang is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~kymang.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.kymang.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except kymang.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
