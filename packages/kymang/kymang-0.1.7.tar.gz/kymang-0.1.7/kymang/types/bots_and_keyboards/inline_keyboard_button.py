...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~kymang.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~kymang.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~kymang.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~kymang.types.CallbackGame`, *optional*):
