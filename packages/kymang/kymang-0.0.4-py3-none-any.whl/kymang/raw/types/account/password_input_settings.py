...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <kymang.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <kymang.raw.base.SecureSecretSettings>`, *optional*):
            N/A
