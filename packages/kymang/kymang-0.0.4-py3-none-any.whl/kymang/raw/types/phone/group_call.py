...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <kymang.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <kymang.raw.base.GroupCallParticipant>`):
            N/A
