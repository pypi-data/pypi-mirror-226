...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <kymang.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <kymang.raw.base.ExportedChatlistInvite>`):
            N/A
