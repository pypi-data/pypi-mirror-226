...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <kymang.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <kymang.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <kymang.raw.base.InlineBotWebView>`, *optional*):
            N/A
