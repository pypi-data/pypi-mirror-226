...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <kymang.raw.base.SearchResultsCalendarPeriod>`):
            N/A
