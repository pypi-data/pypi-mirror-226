...
class SendMedia(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputPeer <kymang.raw.base.InputPeer>`):
            N/A

        media (:obj:`InputMedia <kymang.raw.base.InputMedia>`):
            N/A
        ...
        send_as (:obj:`InputPeer <kymang.raw.base.InputPeer>`, *optional*):
            N/A

    Returns:
        :obj:`Updates <kymang.raw.base.Updates>`
    """
