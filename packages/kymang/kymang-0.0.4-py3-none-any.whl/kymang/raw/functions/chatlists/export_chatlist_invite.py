...
class ExportChatlistInvite(TLObject):  # type: ignore
    ...
    Parameters:
        chatlist (:obj:`InputChatlist <kymang.raw.base.InputChatlist>`):
            N/A

        title (``str``):
            N/A

        peers (List of :obj:`InputPeer <kymang.raw.base.InputPeer>`):
            N/A

    Returns:
        :obj:`chatlists.ExportedChatlistInvite <kymang.raw.base.chatlists.ExportedChatlistInvite>`
    """
