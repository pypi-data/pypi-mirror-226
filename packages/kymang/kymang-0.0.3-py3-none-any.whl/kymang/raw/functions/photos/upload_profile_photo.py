...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <kymang.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <kymang.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <kymang.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <kymang.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <kymang.raw.base.photos.Photo>`
    """
