...
class GetBotCallbackAnswer(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        password (:obj:`InputCheckPasswordSRP <kymang.raw.base.InputCheckPasswordSRP>`, *optional*):
            N/A

    Returns:
        :obj:`messages.BotCallbackAnswer <kymang.raw.base.messages.BotCallbackAnswer>`
    """
