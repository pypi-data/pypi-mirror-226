...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <kymang.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <kymang.raw.base.auth.CodeType>`, *optional*):
            N/A
