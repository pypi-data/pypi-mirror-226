...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <kymang.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <kymang.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <kymang.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <kymang.raw.base.InputDocument>`, *optional*):
            N/A
