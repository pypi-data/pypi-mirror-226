...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <kymang.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <kymang.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <kymang.raw.base.PremiumSubscriptionOption>`):
            N/A
