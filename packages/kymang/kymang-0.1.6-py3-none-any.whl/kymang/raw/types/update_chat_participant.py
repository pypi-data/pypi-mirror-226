...
class UpdateChatParticipant(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        prev_participant (:obj:`ChatParticipant <kymang.raw.base.ChatParticipant>`, *optional*):
            N/A

        new_participant (:obj:`ChatParticipant <kymang.raw.base.ChatParticipant>`, *optional*):
            N/A
