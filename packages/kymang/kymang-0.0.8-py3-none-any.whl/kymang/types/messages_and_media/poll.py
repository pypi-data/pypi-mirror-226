...
import kymang
from kymang import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~kymang.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~kymang.types.MessageEntity`, *optional*):
    ...
    async def stop(
        ...
        """Bound method *stop* of :obj:`~kymang.types.Poll`.
        ...
        Returns:
            :obj:`~kymang.types.Poll`: On success, the stopped poll with the final results is returned.
