...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <kymang.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <kymang.raw.base.VideoSize>`, *optional*):
            N/A
