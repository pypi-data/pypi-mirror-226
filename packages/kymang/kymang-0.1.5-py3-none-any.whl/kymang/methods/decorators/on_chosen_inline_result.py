...
import kymang
from kymang.filters import Filter
...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        This does the same thing as :meth:`~kymang.Client.add_handler` using the
        :obj:`~kymang.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~kymang.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kymang.Client):
                self.add_handler(kymang.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kymang.handlers.ChosenInlineResultHandler(func, self),
