...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <kymang.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <kymang.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <kymang.raw.base.payments.ValidatedRequestedInfo>`
    """
