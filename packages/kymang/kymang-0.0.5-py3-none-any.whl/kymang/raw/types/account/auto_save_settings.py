...
class AutoSaveSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.account.AutoSaveSettings`.
    ...
    Parameters:
        users_settings (:obj:`AutoSaveSettings <kymang.raw.base.AutoSaveSettings>`):
            N/A

        chats_settings (:obj:`AutoSaveSettings <kymang.raw.base.AutoSaveSettings>`):
            N/A

        broadcasts_settings (:obj:`AutoSaveSettings <kymang.raw.base.AutoSaveSettings>`):
            N/A

        exceptions (List of :obj:`AutoSaveException <kymang.raw.base.AutoSaveException>`):
            N/A

        chats (List of :obj:`Chat <kymang.raw.base.Chat>`):
            N/A
