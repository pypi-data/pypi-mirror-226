...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <kymang.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <kymang.raw.base.VideoSize>`, *optional*):
            N/A
