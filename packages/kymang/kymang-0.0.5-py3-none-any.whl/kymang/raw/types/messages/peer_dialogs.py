...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <kymang.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <kymang.raw.base.Message>`):
            N/A
