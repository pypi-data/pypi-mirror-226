...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <kymang.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <kymang.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <kymang.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <kymang.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <kymang.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <kymang.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <kymang.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <kymang.raw.base.StatsGroupTopInviter>`):
            N/A

        users (List of :obj:`User <kymang.raw.base.User>`):
            N/A
