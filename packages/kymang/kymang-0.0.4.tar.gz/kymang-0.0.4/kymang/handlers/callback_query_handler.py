...
from kymang.utils import PyromodConfig
from kymang.types import ListenerTypes
...
class CallbackQueryHandler(Handler):
    ...
    It is intended to be used with :meth:`~kymang.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~kymang.Client.on_callback_query` decorator.
    ...
    Other parameters:
        ...
        callback_query (:obj:`~kymang.types.CallbackQuery`):
