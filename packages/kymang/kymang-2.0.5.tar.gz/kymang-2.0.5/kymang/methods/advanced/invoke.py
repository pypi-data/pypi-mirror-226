...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <kymang.api.functions>` package and may accept compound
        data types from :obj:`types <kymang.api.types>` as well as bare types such as ``int``, ``str``, etc...
