...
class InputThemeSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.InputThemeSettings`.
    ...
    Parameters:
        base_theme (:obj:`BaseTheme <kymang.raw.base.BaseTheme>`):
            N/A
        ...
        wallpaper (:obj:`InputWallPaper <kymang.raw.base.InputWallPaper>`, *optional*):
            N/A

        wallpaper_settings (:obj:`WallPaperSettings <kymang.raw.base.WallPaperSettings>`, *optional*):
            N/A
