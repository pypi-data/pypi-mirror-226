...
class BroadcastStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.stats.BroadcastStats`.
    ...
    Parameters:
        ...
        followers (:obj:`StatsAbsValueAndPrev <kymang.raw.base.StatsAbsValueAndPrev>`):
            N/A

        views_per_post (:obj:`StatsAbsValueAndPrev <kymang.raw.base.StatsAbsValueAndPrev>`):
            N/A

        shares_per_post (:obj:`StatsAbsValueAndPrev <kymang.raw.base.StatsAbsValueAndPrev>`):
            N/A

        enabled_notifications (:obj:`StatsPercentValue <kymang.raw.base.StatsPercentValue>`):
            N/A

        growth_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        followers_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        mute_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        interactions_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        iv_interactions_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        views_by_source_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        new_followers_by_source_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <kymang.raw.base.StatsGraph>`):
            N/A

        recent_message_interactions (List of :obj:`MessageInteractionCounters <kymang.raw.base.MessageInteractionCounters>`):
            N/A
