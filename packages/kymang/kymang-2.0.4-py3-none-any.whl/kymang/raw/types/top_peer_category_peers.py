...
class TopPeerCategoryPeers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.TopPeerCategoryPeers`.
    ...
    Parameters:
        category (:obj:`TopPeerCategory <kymang.raw.base.TopPeerCategory>`):
            N/A

        count (``int`` ``32-bit``):
            N/A

        peers (List of :obj:`TopPeer <kymang.raw.base.TopPeer>`):
            N/A
