...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~kymang.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <kymang.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <kymang.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~kymang.raw.types`
    """
