...
class SendEncryptedFile(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputEncryptedChat <kymang.raw.base.InputEncryptedChat>`):
            N/A
        ...
        file (:obj:`InputEncryptedFile <kymang.raw.base.InputEncryptedFile>`):
            N/A
    ...
    Returns:
        :obj:`messages.SentEncryptedMessage <kymang.raw.base.messages.SentEncryptedMessage>`
    """
