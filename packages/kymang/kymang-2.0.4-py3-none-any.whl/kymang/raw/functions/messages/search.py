...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <kymang.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <kymang.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <kymang.raw.base.messages.Messages>`
    """
