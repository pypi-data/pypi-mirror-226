...
class BotCommandScope(Object):
    ...
    - :obj:`~kymang.types.BotCommandScopeDefault`
    - :obj:`~kymang.types.BotCommandScopeAllPrivateChats`
    - :obj:`~kymang.types.BotCommandScopeAllGroupChats`
    - :obj:`~kymang.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~kymang.types.BotCommandScopeChat`
    - :obj:`~kymang.types.BotCommandScopeChatAdministrators`
    - :obj:`~kymang.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "kymang.Client") -> "raw.base.BotCommandScope":
