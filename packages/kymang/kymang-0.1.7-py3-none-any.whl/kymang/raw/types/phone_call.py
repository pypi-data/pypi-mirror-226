...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <kymang.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <kymang.raw.base.PhoneConnection>`):
            N/A
