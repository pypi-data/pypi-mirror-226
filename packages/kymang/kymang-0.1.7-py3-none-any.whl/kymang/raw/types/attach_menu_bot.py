...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <kymang.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <kymang.raw.base.AttachMenuBotIcon>`):
            N/A
