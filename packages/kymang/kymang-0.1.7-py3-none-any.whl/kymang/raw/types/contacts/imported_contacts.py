...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <kymang.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <kymang.raw.base.PopularContact>`):
            N/A
