...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <kymang.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <kymang.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <kymang.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <kymang.raw.base.Document>`):
            N/A
