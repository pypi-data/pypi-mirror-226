...
class AppUpdate(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~kymang.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        entities (List of :obj:`MessageEntity <kymang.raw.base.MessageEntity>`):
            N/A
        ...
        sticker (:obj:`Document <kymang.raw.base.Document>`, *optional*):
            N/A
