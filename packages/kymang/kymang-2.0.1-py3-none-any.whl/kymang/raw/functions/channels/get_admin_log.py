...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        channel (:obj:`InputChannel <kymang.raw.base.InputChannel>`):
            N/A
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <kymang.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <kymang.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <kymang.raw.base.channels.AdminLogResults>`
    """
