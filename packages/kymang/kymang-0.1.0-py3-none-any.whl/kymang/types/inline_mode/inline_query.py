...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~kymang.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <kymang.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~kymang.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~kymang.types.InlineQueryResult`):
