...
class GetSchemasRequest(google.protobuf.message.Message):
    ...
    RETURNCOLLECTIONS_FIELD_NUMBER: builtins.int
    ...
    returnCollections: builtins.bool
...
class GetSchemasResponse(google.protobuf.message.Message):
    ...
    @typing_extensions.final
    class CollectionDefinition(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        MANIFOLDVALUES_FIELD_NUMBER: builtins.int
        ...
        def __init__(
            ...
            *,
            ...
            | None = ...,
            manifoldValues: collections.abc.Iterable[global___MetadataValue]
            | None = ...,
        ) -> None: ...
        def ClearField(
            self,
    ...
    class SchemaDefinition(google.protobuf.message.Message):
        ...
        SCHEMA_FIELD_NUMBER: builtins.int
        COLLECTIONDEFINITIONS_FIELD_NUMBER: builtins.int
        @property
        def schema(self) -> global___Schema: ...
        @property
        def collectionDefinitions(
            self,
        ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
            global___GetSchemasResponse.CollectionDefinition
        ]: ...
        def __init__(
            self,
            *,
            schema: global___Schema | None = ...,
            collectionDefinitions: collections.abc.Iterable[
                global___GetSchemasResponse.CollectionDefinition
            ]
            | None = ...,
        ) -> None: ...
        ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal[
                "collectionDefinitions", b"collectionDefinitions", "schema", b"schema"
            ],
        ) -> None: ...
...
class Schema(google.protobuf.message.Message):
    ...
    REQUIREREINDEXSKEWTHRESHOLD_FIELD_NUMBER: builtins.int
    REQUIREREINDEXCHANGELOGSIZE_FIELD_NUMBER: builtins.int
    id: builtins.int
    ...
    requireReindexSkewThreshold: builtins.float
    """How much skew in centroid values is allowed before reindexing"""
    requireReindexChangeLogSize: builtins.int
    """How many new records can be inserted into one cluster before reindexing"""
    def __init__(
        self,
        *,
        id: builtins.int = ...,
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            "name",
            b"name",
            "requireReindexChangeLogSize",
            b"requireReindexChangeLogSize",
            "requireReindexSkewThreshold",
            b"requireReindexSkewThreshold",
        ],
    ) -> None: ...
