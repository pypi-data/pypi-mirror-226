...
from .input_types import (
    ...
    SetPromotionalEntitlementsInput,
...
from .set_promotional_entitlements import SetPromotionalEntitlements
...
class AsyncClient(AsyncBaseClient):
    ...
    async def set_promotional_entitlements(
        self, input: SetPromotionalEntitlementsInput
    ) -> SetPromotionalEntitlements:
        query = gql(
            """
            mutation SetPromotionalEntitlements($input: SetPromotionalEntitlementsInput!) {
        ...
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return SetPromotionalEntitlements.parse_obj(data)
    ...
    async def checkout_state(self, input: CheckoutStateInput) -> CheckoutState:
        query = gql(
            """
            query CheckoutState($input: CheckoutStateInput!) {
        ...
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return CheckoutState.parse_obj(data)
