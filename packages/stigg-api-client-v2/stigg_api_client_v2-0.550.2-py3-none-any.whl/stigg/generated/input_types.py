...
class SetPromotionalEntitlementInput(BaseModel):
...
class SetPromotionalEntitlementsInput(BaseModel):
    customer_id: str = Field(alias="customerId")
    environment_id: Optional[str] = Field(alias="environmentId")
    promotional_entitlements: List["SetPromotionalEntitlementInput"] = Field(
        alias="promotionalEntitlements"
    )
...
SetPromotionalEntitlementInput.update_forward_refs()
SetPromotionalEntitlementsInput.update_forward_refs()
