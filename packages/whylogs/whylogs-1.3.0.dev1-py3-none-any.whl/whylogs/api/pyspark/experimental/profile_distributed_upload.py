...
def _profile_partition(partition, partition_schema, dataset_timestamp: Optional[int] = None, schema: Optional[DatasetSchema] = None):
...
def _profile_and_upload_to_whylabs(
    ...
    profiler_with_schema = partial(_profile_partition, partition_schema=input_df.schema, schema=schema, dataset_timestamp=dataset_timestamp)
