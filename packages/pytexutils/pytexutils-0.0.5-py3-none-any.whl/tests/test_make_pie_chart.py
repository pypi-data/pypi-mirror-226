...
from pytexutils.graphs.make_pie_chart import make_pie_chart
...
if __name__ == '__main__':
    ...
    latex_pie_chart = make_pie_chart(data, caption='My pie chart 2', label='pie2', preamble=True, ctype="square")
