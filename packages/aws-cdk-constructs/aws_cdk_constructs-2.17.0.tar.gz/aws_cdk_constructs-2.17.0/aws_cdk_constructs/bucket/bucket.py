    ...
    def __init__(
        ...
        **kwargs
        ...
        self.bucket = self.create_bucket(
            ...
            block_public_access=_s3.BlockPublicAccess.BLOCK_ALL if not public_read_access else _s3.BlockPublicAccess(block_public_acls=False, block_public_policy=False, ignore_public_acls=False, restrict_public_buckets=False),
            versioned=versioned,
