...
class Components:
    ...
    filter_dropdown = html.Div(id='filter_dropdown',
                               children=dbc.Select(id='filter_name',
                                                   ...
                                                   options=[
                                                       ...
                                                       {'label': 'Higher Net Profit', 'value': 'higher_net_profit'},
                                                       {'label': 'Lower MDD', 'value': 'lower_mdd'},
                                                       {'label': 'Higher Net Profit/MDD', 'value': 'higher_net_profit_mdd'},
                                                       {'label': 'Higher Ann. Sharpe Ratio', 'value': 'higher_ann_sharpe'},
    ...
    def __init__(self,number_of_curves):
        self.sort_method_dropdown = html.Div(
            dbc.Select(id='sort_method',
                       ...
                       value=f'Top NNP',
                       options=[{'label': f'Top {number_of_curves} Normalized Net Profit', 'value': 'Top NNP'},
                                {'label': f'Top {number_of_curves} Return on Capital Selected vs BaH Difference', 'value': 'Top SB Diff'},
    ...
    def update_performance_matrix(self, start_date,end_date,df,para_dict, risk_free_rate, ref_code):
        ...
        try:
            ...
            df['bah_net_return'] = "{:,}".format(int(round(df['bah_net_return'], 0)))
            if df['bah_net_profit_to_mdd'] == np.inf: df['bah_net_profit_to_mdd'] = 'inf'
            else: df['bah_net_profit_to_mdd'] = round(df['bah_net_profit_to_mdd'], 2)
            df['bah_mdd_dollar'] = "{:,}".format(int(round(df['bah_mdd_dollar'], 0)))
            df['bah_mdd_pct'] = "{:.0%}".format(df['bah_mdd_pct'] / 100)
            df['bah_return_on_capital'] = "{:.0%}".format(df['bah_return_on_capital'] / 100)
        ...
        vs_bnh_col = [dbc.Row([dbc.Col(style={'margin-left':'0px'}, width=5),
                              dbc.Col('Selected', style={'text-align': 'center', 'font-weight': 'bold', 'color':'yellow'},width=3),
                              dbc.Col('BaH', style={'text-align': 'center', 'font-weight': 'bold', 'color': 'yellow'}, width=3)
                              ], style={'font-size': '11px'})]

        vs_bnh_col.append(dbc.Row([dbc.Col('Net Profit', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['net_profit'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bah_net_return'], style={'text-align': 'center'}, width=3),
                                   ]))
        vs_bnh_col.append(dbc.Row([dbc.Col('Net Profit/MDD', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['net_profit_to_mdd'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bah_net_profit_to_mdd'], style={'text-align': 'center'}, width=3),
                                   ]))
        vs_bnh_col.append(dbc.Row([dbc.Col('Return on Capital', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['return_on_capital'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bah_return_on_capital'], style={'text-align': 'center'}, width=3),
                                   ]))

        vs_bnh_col.append(html.Div(html.Img()))

        vs_bnh_col.append(dbc.Row([dbc.Col('Ann. Return', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['annualized_return'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bah_annualized_return'], style={'text-align': 'center'}, width=3),
                                   ]))
        vs_bnh_col.append(dbc.Row([dbc.Col('Ann. Std', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['annualized_std'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bah_annualized_std'], style={'text-align': 'center'}, width=3),
                                   ]))
        vs_bnh_col.append(dbc.Row([dbc.Col('Ann. Sharpe Ratio', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['annualized_sr'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bah_annualized_sr'], style={'text-align': 'center'}, width=3),
                                   ]))
        vs_bnh_col.append(dbc.Row([dbc.Col('MDD Dollar', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['mdd_dollar'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bah_mdd_dollar'], style={'text-align': 'center'}, width=3),
                                   ]))
        vs_bnh_col.append(dbc.Row([dbc.Col('MDD Percentage', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['mdd_pct'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bah_mdd_pct'], style={'text-align': 'center'}, width=3),
                                   ]))

        vs_bnh_col.append(html.Div(html.Img()))

        vs_bnh_col.append(dbc.Row([dbc.Col('Total Commission', style={'margin-left': '0px'}, width=5),
                                   dbc.Col(df['total_commission'], style={'text-align': 'center'}, width=3),
                                   dbc.Col(df['bnh_total_commission'], style={'text-align': 'center'}, width=3),
                                   ]))
        try:
            vs_bnh_col.append(dbc.Row([dbc.Col('Risk Free Rate', style={'margin-left': '0px'}, width=5),
                                       dbc.Col("{:.2%}".format(risk_free_rate / 100) , style={'text-align': 'center'}, width=3),
                                       dbc.Col("{:.2%}".format(risk_free_rate / 100) , style={'text-align': 'center'}, width=3),
                                       ]))
        except:
            vs_bnh_col.append(dbc.Row([dbc.Col('Risk Free Rate', style={'margin-left': '0px'}, width=5),
                                       dbc.Col('-----', style={'text-align': 'center'}, width=3),
                                       dbc.Col('-----', style={'text-align': 'center'},  width=3),
                                       ]))
        ...
        matrix_div = html.Div([
            ...
            html.Div('Selected vs BnH', style={'color': 'Cyan', 'font-size': '15px'}),
            html.Div(style={'height': '5px', }),
            html.Div(children=vs_bnh_col, style={'font-size': '11px'}),
    ...
    filter_options = {
        ...
        'exclude': 'Exclude',
        'higher_net_profit': 'Higher Net Profit',
        'lower_mdd': 'Lower MDD',
        'higher_net_profit_mdd': 'Higher Net Profit/MDD',
        'higher_ann_sharpe': 'Higher Ann. Sharpe Ratio'
        }
    ...
    def sort_method_df(self, sort_method, result_df, number_of_curves):
        ...
        elif sort_method == 'Top NNP':
            df_sorted = result_df.sort_values(by='normalized_net_profit', ascending=False).head(number_of_curves).copy()
        elif sort_method == 'Top SB Diff':
            df_sorted = result_df.sort_values(by='return_selected_bah', ascending=False).head(number_of_curves).copy()
        else:
    ...
    def generate_chart_3(self, para_combination, chart3_start, chart3_end, freq, file_format):
        ...
        save_path = hedgeguy.generate_filepath(para_combination=para_combination)
        if file_format == 'parquet':
    ...
    def generate_chart_1(self, graph_df, all_para_combination, intraday, summary_mode):
        ...
        for i in graph_df.index:
            ...
            if (intraday or summary_mode):
                df_daily = hedgeguy.resample_summary_to_daily(para_combination=para_combination)
            else:
                save_path = hedgeguy.generate_filepath(para_combination=para_combination)
                if file_format == 'parquet':
            ...
            df_daily['normalized_net_profit'] = df_daily['equity_value'] / df_daily.loc[df_daily.index[0], 'equity_value']

            hovertemplate = hovertemplate + "Equity : %{y:,.0f}"

            fig_line.add_trace(go.Scatter(mode='lines', hovertemplate=hovertemplate,
                                          x=df_daily['date'], y=df_daily['normalized_net_profit'],
    ...
    def generate_chart_2_full(self, para_combination, line_colour, aggregate_boolean, settings):
        ...
        fig_line.add_trace(go.Scatter(mode='lines',
                                      x=df_chart['date'], y=df_chart['equity_value'],
                                      line=dict(color=line_colour, width=1.5), name='Strategy Equity'), )
        ...
        # fig_line.add_trace(go.Scatter(mode='lines',
        #                               x=df_chart['date'], y=df_chart['equity_value'],
        #                               line=dict(color='SpringGreen', width=1.5), name='Selected'), )

        fig_line.add_trace(go.Scatter(mode='lines',
                                      x=df_chart['date'], y=df_chart['bnh'],
                                      line=dict(color='Grey', width=1.5), name='BnH'), )
    ...
    def aggregate_df(self):
        ...
        for folder in folders:
            ...
            for i, row in df_saved.iterrows():
                ...
                file_format = para_combination['file_format']
                save_name = hedgeguy.filename_only(para_combination)
                ref_code = hedgeguy.path_reference_code(save_name)
        ...
        if isinstance(risk_free_rate, str):
            try:
                if risk_free_rate == 'geometric_mean':
                    ...
                    risk_free_rate_float = hedgeguy.get_geometric_mean_of_yearly_rate(start_date_year, end_date_year)
                else:
                    risk_free_rate_float = hedgeguy.get_latest_fed_fund_rate()
            except:
