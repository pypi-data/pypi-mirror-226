...
class LambdaInvoker(object):
    def __init__(self, user_id, service_name, region_name, lambda_function_name, access_key_id, access_key_secret):

        self.client = fun_client.create_client(user_id, access_key_id, access_key_secret)
    ...
    def invoke(self, payload):
        ...
        fun_client.invoke_function(self.client, self.service_name, self.lambda_function_name, payload)
