...
def extract_storage_config(config):
    ...
    if storage_config['storage_backend'] == 's3':
        ...
        storage_config['backend_config']['endpoint'] = config['runtime']['endpoint']
        storage_config['backend_config']['region'] = config['account']['aws_region']
        storage_config['backend_config']['access_key_id'] = config['account']['access_key_id']
        storage_config['backend_config']['access_key_secret'] = config['account']['access_key_secret']
...
RUNTIME_BUCKET_REGION = {'cn-beijing' : 'zdy-public'}

TARGET_AMI_REGION = {'cn-beijing' : 'ami-0bdb828fd58c52235'}
