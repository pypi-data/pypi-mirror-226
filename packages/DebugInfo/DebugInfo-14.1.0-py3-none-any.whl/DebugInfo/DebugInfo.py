...
class 调试模板:
    ...
    @表格列宽.setter
    def 表格列宽(self, 列宽控制表: list[int]):
        if isinstance(列宽控制表, int):
            self.__表格列宽控制表 = [列宽控制表]
        elif isinstance(列宽控制表, list):
            self.__表格列宽控制表 = []
            for 列宽 in 列宽控制表:
    ...
    def 副本(self):
        ...
        # 复制表格列间距
        if self.__表格列间距 is not None:
            if isinstance(self.__表格列间距, int):
                副本._调试模板__表格列间距 = self.__表格列间距
            elif isinstance(self.__表格列间距, list):
                副本._调试模板__表格列间距 = copy(self.__表格列间距)
