...
class 分隔线模板:
    ...
    __修饰方法: Callable[[str], str] or list[Callable[[str], str]] = None
    ...
    def __init__(self,
                 ...
                 修饰方法: Callable[[str], str] or list[Callable[[str], str]] = None,
                 打印方法: callable = print):
        if 符号 is not None:
            self.__符号 = str(符号)
        if 提示内容 is not None:
    ...
    def 修饰方法(self) -> list[callable]:
        if callable(self.__修饰方法):
            ...
            return copy(self.__修饰方法)
        else:
            return []

    @修饰方法.setter
    def 修饰方法(self, 方法: Callable[[str], str] or list[Callable[[str], str]]):
        if callable(方法):
            self.__修饰方法 = 方法
    ...
    def 副本(self):
        ...
        副本._分隔线模板__特殊字符宽度字典 = copy(self.__特殊字符宽度字典)
    ...
    def 修饰(self, 方法: Callable[[str], str] or list[Callable[[str], str]]):
        """
...
class 调试模板:
    ...
    def 副本(self):
        ...
        # 复制 特殊字符宽度字典
        副本._调试模板__特殊字符宽度字典 = copy(self.__特殊字符宽度字典)
        ...
        # 复制表格列宽表
        if self.__表格列宽:
            副本._调试模板__表格列宽表 = copy(self.__表格列宽)
    ...
    def 准备表格(self, 对齐控制串: str = None, 列宽控制表: list[int] = None):
        ...
        class 次次级方法类:
            def 修饰行(self, 方法: Callable[[str], str] or list[Callable[[str], str]] = None) -> None:
                pass

        class 添加多行次级方法类:
            def 展示表格(self, 列间距: list[int] or int = None, 打印方法: Callable[[str], None] = print) -> None:
                pass
    ...
    def 修饰列(self, 指定列: list[int] or int, 修饰方法: list[Callable[[str], str]] or Callable[[str], str]):
        """
        对指定的列用指定的方法进行修饰
    ...
    def __修饰最后一行(self, 方法: Callable[[str], str] or list[Callable[[str], str]] = None) -> None:
        if not self.__表格:
            return None
