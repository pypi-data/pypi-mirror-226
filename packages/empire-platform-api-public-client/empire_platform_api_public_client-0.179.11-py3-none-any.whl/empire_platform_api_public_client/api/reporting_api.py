...
class ReportingApi(object):
    ...
    @validate_arguments
    def get_auction_allocation_results_report(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], **kwargs) -> str:  # noqa: E501
        ...
        >>> thread = api.get_auction_allocation_results_report(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_auction_allocation_results_report_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_auction_allocation_results_report_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], **kwargs) -> ApiResponse:  # noqa: E501
        """get_auction_allocation_results_report  # noqa: E501
        ...
        >>> thread = api.get_auction_allocation_results_report_with_http_info(id, async_req=True)
        >>> result = thread.get()
