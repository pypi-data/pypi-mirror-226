...
class TestConfigValidator:
    ...
    def test_validate(
        ...
        with expect_raise_if_exception(expected_error) as e:
            ...
            elif config_path == "unicore_config_yaml":
                config_path = unicore_config_yaml
            elif config_path == "unicore_config_json":
                config_path = unicore_config_json
    ...
    def test_validate_config_not_in_exclude(
        ...
        config_file_name = "unicore-config.yaml"
