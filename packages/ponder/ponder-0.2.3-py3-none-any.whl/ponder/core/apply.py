...
class ApplyUDFNode(QueryTreeNode):
    def __init__(
        ...
        output_column_aliases, output_aliases_map = self._conn.setup_udtf(
            ...
            self._input_node.get_column_types(),
            output_column_list,
            db_output_column_types,
    ...
    def generate_sql(self):
        ...
        input_node_column_types = (
            self._input_node.get_column_types().tolist() + self._labels_and_pos_dtypes
            if isinstance(self._input_node.get_column_types(), pandas.Series)
            else self._input_node.get_column_types() + self._labels_and_pos_dtypes
        )
