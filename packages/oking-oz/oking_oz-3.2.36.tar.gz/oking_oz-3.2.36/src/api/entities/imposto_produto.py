...
# # com leiaute da http://api.gmimportacao.openk.com.br/ok/swagger/ui/index#!/Catalogo/impostoNCM
class ImpostoProduto:
    def __init__(self, codigo_sku, ncm, grupo_tributacao, grupo_cliente,
                 uf_origem, uf_destino,mva_iva, icms_intraestadual,
                  icms_interestadual, percentual_reducao_base_calcul, identificador):
