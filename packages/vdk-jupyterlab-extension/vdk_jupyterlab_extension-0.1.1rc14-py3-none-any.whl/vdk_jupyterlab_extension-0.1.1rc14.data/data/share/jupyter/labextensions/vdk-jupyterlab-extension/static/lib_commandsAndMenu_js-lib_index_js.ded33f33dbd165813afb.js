...
/* harmony export */ });
/* harmony import */ var _components_RunJob__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/RunJob */ "./lib/components/RunJob.js");
/* harmony import */ var _jobData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./jobData */ "./lib/jobData.js");
/* harmony import */ var _components_DeployJob__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/DeployJob */ "./lib/components/DeployJob.js");
/* harmony import */ var _components_CreateJob__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/CreateJob */ "./lib/components/CreateJob.js");
/* harmony import */ var _components_DownloadJob__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/DownloadJob */ "./lib/components/DownloadJob.js");
/* harmony import */ var _components_ConvertJobToNotebook__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/ConvertJobToNotebook */ "./lib/components/ConvertJobToNotebook.js");
/* harmony import */ var _serverRequests__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./serverRequests */ "./lib/serverRequests.js");
/* harmony import */ var _vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./vdkOptions/vdk_options */ "./lib/vdkOptions/vdk_options.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! . */ "./lib/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils */ "./lib/utils.js");
/* harmony import */ var _components_props__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/props */ "./lib/components/props.js");
...
function updateVDKMenu(commands, docManager, fileBrowser, notebookTracker, statusButton) {
    // Add Run job command
    add_command(commands, 'jp-vdk:menu-run', 'Run', 'Execute VDK Run Command', _components_RunJob__WEBPACK_IMPORTED_MODULE_0__.showRunJobDialog, statusButton, docManager);
    // Add Create job command
    add_command(commands, 'jp-vdk:menu-create', 'Create', 'Execute VDK Create Command', _components_CreateJob__WEBPACK_IMPORTED_MODULE_1__.showCreateJobDialog, statusButton);
    // Add Download job command
    add_command(commands, 'jp-vdk:menu-download', 'Download', 'Execute VDK Download Command', _components_DownloadJob__WEBPACK_IMPORTED_MODULE_2__.showDownloadJobDialog, statusButton);
    // Add Convert Job To Notebook command
    add_command(commands, 'jp-vdk:menu-convert-job-to-notebook', 'Convert Job To Notebook', 'Convert Data Job To Jupyter Notebook', _components_ConvertJobToNotebook__WEBPACK_IMPORTED_MODULE_3__.showConvertJobToNotebookDialog, statusButton, undefined, fileBrowser, notebookTracker);
    // Add Create Deployment command
    add_command(commands, 'jp-vdk:menu-create-deployment', 'Deploy', 'Create deployment of a VDK job', _components_DeployJob__WEBPACK_IMPORTED_MODULE_4__.showCreateDeploymentDialog, statusButton);
}
/**
        ...
        execute: async () => {
            try {
                if (!runningVdkOperation) {
                    ...
                    _jobData__WEBPACK_IMPORTED_MODULE_5__.jobData.set(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_6__.VdkOption.PATH, ___WEBPACK_IMPORTED_MODULE_7__.workingDirectory);
                    await (0,_serverRequests__WEBPACK_IMPORTED_MODULE_8__.jobdDataRequest)();
                    ...
                    statusButton.hide();
                    (0,_jobData__WEBPACK_IMPORTED_MODULE_5__.setJobDataToDefault)();
                    runningVdkOperation = '';
                }
                else {
                    await (0,_components_props__WEBPACK_IMPORTED_MODULE_9__.showErrorDialog)({
                        title: _utils__WEBPACK_IMPORTED_MODULE_10__.ERROR_LABEL,
                        messages: [
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.ded33f33dbd165813afb.js.map