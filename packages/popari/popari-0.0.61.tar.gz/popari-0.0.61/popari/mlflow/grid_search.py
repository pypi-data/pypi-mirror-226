...
def run():
    ...
    with mlflow.start_run() as parent_run:
        ...
        special_options = []
        for profile_name, special_profile in special_profiles.items():
            is_novel = [True if hyperparameter_name in special_profile else False for hyperparameter_name in hyperparameter_names]
          
            special_options_list = [hyperparameter_options if not is_novel[index] else [special_profile[hyperparameter_name]] for index, (hyperparameter_name, hyperparameter_options) in enumerate(zip(hyperparameter_names, hyperparameter_options_list))]
        ...
        options = special_options + options
