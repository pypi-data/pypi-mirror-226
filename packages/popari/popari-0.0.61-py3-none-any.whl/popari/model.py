...
class Popari:
    ...
    def superresolve(self, differentiate_spatial_affinities: bool = True,
            ...
            use_manual_gradients: bool = False, n_epochs: int = 10000, tol: float = 1e-5):
        ...
        for level in range(self.hierarchical_levels-2, -1, -1):
            ...
            view._superresolve_embeddings(n_epochs=n_epochs, tol=tol, use_manual_gradients=use_manual_gradients)
