...
def load_from_mlflow_run(run, client, **loading_kwargs):
    ...
    trained_model_artifact, = list(filter(lambda artifact: artifact.path.startswith("device_"), artifacts))
    print(trained_model_artifact)
