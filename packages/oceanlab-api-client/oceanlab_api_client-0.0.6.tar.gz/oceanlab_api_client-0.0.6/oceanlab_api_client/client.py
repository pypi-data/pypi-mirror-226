...
class AuthenticatedClient:
    ...
    token: str = None
    client_id: str = "b454696a-def0-4481-825f-fed836d600e3"
    prefix: str = "Bearer"
    ...
    def login(self) -> None:
        ...
        self._ms_client = msal.PublicClientApplication(
            client_id=self.client_id, authority="https://login.microsoftonline.com/e1f00f39-6041-45b0-b309-e0210d8b32af"
        )
    ...
    def login_external(self) -> None:
        ...
        b2c_client_id = "3e7d58ba-7a4e-4f67-957d-931cc60ed4b4"
        b2c_authority = "https://datasintefdev.b2clogin.com/7272a89b-4f78-4aaa-82b6-c49329164dcc/b2c_1_susi_local"
        self._ms_client = msal.PublicClientApplication(client_id=b2c_client_id, authority=b2c_authority)
