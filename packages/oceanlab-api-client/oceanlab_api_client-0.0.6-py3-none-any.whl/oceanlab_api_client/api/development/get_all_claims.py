...
from ...models.get_all_claims_response_200 import GetAllClaimsResponse200
...
def _get_kwargs() -> Dict[str, Any]:
    ...
    return {
        "method": "get",
        "url": "/Development/GetAllClaims",
    }


def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[GetAllClaimsResponse200]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetAllClaimsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[GetAllClaimsResponse200]:
    return Response(
