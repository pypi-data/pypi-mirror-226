import ctypes
class SequentialQueue_double:
    def __init__(self):
        self.__queue=ctypes.cdll.LoadLibrary('./Libraries/SequentialQueue_double')
