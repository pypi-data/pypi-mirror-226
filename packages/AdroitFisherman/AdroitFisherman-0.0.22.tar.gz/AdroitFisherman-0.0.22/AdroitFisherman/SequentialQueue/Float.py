import ctypes
class SequentialQueue_float:
    def __init__(self):
        self.__queue=ctypes.cdll.LoadLibrary('./Libraries/SequentialQueue_float')
