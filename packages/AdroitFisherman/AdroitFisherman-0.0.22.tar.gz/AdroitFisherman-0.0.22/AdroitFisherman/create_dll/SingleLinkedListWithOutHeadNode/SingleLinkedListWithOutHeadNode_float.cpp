#include "SingleLinkedListWithOutHeadNode_float.h"
#include <iostream>
#include "DataStorage.h"
DataStorage::SingleLinkedListWithOutHeadNode<float>LIST = DataStorage::SingleLinkedListWithOutHeadNode<float>();
void init_list()
{
	LIST.InitList();
}
