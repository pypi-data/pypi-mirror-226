...
namespace DataStorage
{
    ...
    {
    public:
        SequentialQueue(int max_size=255) :size(max_size) {
            Queue.base = NULL;
        }
    ...
    template <class T>
    void SequentialQueue<T>::SetCapacity(int length)
    {
        (*this).size = length;
    }
    template <class T>
    ...
    {
    public:
        CircularQueue(int maxium_size=255):max_size(maxium_size){}
    ...
    template <class T>
    void CircularQueue<T>::SetCapacity(int size)
    {
        max_size = size;
    }
    template <class T>
    ...
    T CircularQueue<T>::GetHead()
    {
        ...
        {
            return Queue.base[Queue.q_front%Queue.q_size];
        }
    }
    template <class T>
