...
class DoubleLinkedListWithoutHeadNode_int():
    def __init__(self):
        self.__list = ctypes.cdll.LoadLibrary("./Libraries/DoubleLinkedListWithoutHeadNode_int.dll")
