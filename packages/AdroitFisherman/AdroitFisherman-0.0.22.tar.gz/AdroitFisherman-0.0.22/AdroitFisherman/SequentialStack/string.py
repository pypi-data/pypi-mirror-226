...
class SequentialStack_string:
    def __init__(self):
        self.__stack = ctypes.cdll.LoadLibrary('./Libraries/SequentialStack_string')
    ...
    def get_top(self):
        ...
        get_top.restype = ctypes.c_char_p
        return ctypes.c_char_p(get_top()).value
    ...
    def pop(self):
        ...
        pop.restype = ctypes.c_char_p
        return ctypes.c_char_p(pop()).value
