...
from mcodegpthippa import DEFAULT_MODEL
from mcodegpthippa.clients import OpenAIClient
from mcodegpthippa.templates.core import ExtractionResult, NamedEntity
import keyring
...
class KnowledgeEngine(ABC):
    ...
    def _get_template_class(self, template: TEMPLATE_NAME) -> ClassDefinition:
        ...
        if class_name is None:
            ...
            class_name = roots[0]
        mod = importlib.import_module(f"mcodegpthippa.templates.{module_name}")
    ...
    def set_up_client(self):
        ...
        openai.api_key = keyring.get_password("system", "api_key")
        openai.api_base = "https://testgpt001.openai.azure.com/"  # your endpoint should look like the following
        openai.api_type = 'azure'
        openai.api_version = '2023-05-15'  # this may change in the future
        deployment_name = 'testgpt001_model'  # This will correspond to the custom name you chose for your deployment when you deployed a model.
