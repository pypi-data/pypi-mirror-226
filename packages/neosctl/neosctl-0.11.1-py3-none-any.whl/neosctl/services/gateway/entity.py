...
def get_entity_journal(
    ...
    util.get_and_process(ctx, f"{url_prefix}/{identifier}/journal", params=params)


def update_entity_journal(ctx: typer.Context, url_prefix: str, identifier: str, filepath: str) -> None:
