...
class LocationProfile(GenericCRUD):
    ...
    def __del__(self):
        ...
        logger.start(DEL_METHOD_NAME)
        self.cursor.close()
        self.connection.close()
        logger.end(DEL_METHOD_NAME)
    ...
    def get_last_location_id_by_profile_id(self, profile_id: int) -> int:
        ...
        logger.start(GET_LAST_LOCATION_ID_BY_PROFILE_ID_METHOD_NAME, object={'profile_id': profile_id})
        ...
        logger.end(GET_LAST_LOCATION_ID_BY_PROFILE_ID_METHOD_NAME, object={'location_id':location_id})
        return location_id
    ...
    def get_location_ids_by_profile_id(self, profile_id: int) -> list[int]:
        ...
        logger.start(GET_LOCATION_IDS_BY_PROFILE_ID_METHOD_NAME, object={'profile_id': profile_id})
        ...
        logger.end(GET_LOCATION_IDS_BY_PROFILE_ID_METHOD_NAME, object={'location_id':location_id})
        return location_ids
    ...
    def insert_location_profile(self, profile_id: int, location_id: int, lang_code: str = 'en', title: str = 'Home', title_approved = True):
        ...
        logger.start(INSERT_LOCATION_PROFILE_METHOD_NAME, object = {"location_id": location_id})
