...
class SetPromotionalEntitlementInput(sgqlc.types.Input):
    __schema__ = schema
...
class SetPromotionalEntitlementsInput(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('customer_id', 'environment_id', 'promotional_entitlements')
    customer_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='customerId')
    environment_id = sgqlc.types.Field(String, graphql_name='environmentId')
    promotional_entitlements = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(SetPromotionalEntitlementInput))), graphql_name='promotionalEntitlements')
...
class Mutation(sgqlc.types.Type):
    ...
    set_promotional_entitlements = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('PromotionalEntitlement'))), graphql_name='setPromotionalEntitlements', args=sgqlc.types.ArgDict((
        ('input', sgqlc.types.Arg(sgqlc.types.non_null(SetPromotionalEntitlementsInput), graphql_name='input', default=None)),
))
    )
