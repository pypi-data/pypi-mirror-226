...
def mutation_set_promotional_entitlements():
    _op = sgqlc.operation.Operation(_schema_root.mutation_type, name='SetPromotionalEntitlements', variables=dict(input=sgqlc.types.Arg(sgqlc.types.non_null(_schema.SetPromotionalEntitlementsInput))))
    _op_set_promotional_entitlements = _op.set_promotional_entitlements(input=sgqlc.types.Variable('input'))
    _op_set_promotional_entitlements.__fragment__(fragment_promotional_entitlement_fragment())
    return _op
...
class Mutation:
    ...
    set_promotional_entitlements = mutation_set_promotional_entitlements()
...
def query_checkout_state():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='CheckoutState', variables=dict(input=sgqlc.types.Arg(sgqlc.types.non_null(_schema.CheckoutStateInput))))
...
class Query:
    checkout_state = query_checkout_state()
