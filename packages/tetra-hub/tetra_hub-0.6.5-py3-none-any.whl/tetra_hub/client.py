...
def _is_mlpackage_supported(
    device_attributes: Union[str, List[str]], os_version: str
) -> bool:
    """
        ...
        for dev in device:
            ...
            if model_type == SourceModelType.MLPACKAGE and not _is_mlpackage_supported(
                ...
                raise UserError(
                    ...
                    " Please either provide target iOS15+ (or macOS12+) for .mlpackage or .mlmodel for iOS14 (or macOS11) and below."
                )
            if (
