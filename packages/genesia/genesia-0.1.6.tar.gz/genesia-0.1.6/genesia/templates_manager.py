...
available_templates_url = {
    "django": "https://github.com/genesia-dev/genesia-templates.git"
}
...
def create_project_from_template(template_name, project_name, jinja_result):
    ...
    templates_dir = "genesia-templates"
    
    git.Repo.clone_from(available_templates_url[template_name], templates_dir)
