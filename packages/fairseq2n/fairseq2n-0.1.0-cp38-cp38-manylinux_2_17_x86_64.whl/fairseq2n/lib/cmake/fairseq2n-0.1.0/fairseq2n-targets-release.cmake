...
set_target_properties(fairseq2n::fairseq2n PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "TBB::tbb;SndFile::sndfile"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfairseq2n.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libfairseq2n.so.0"
  )

list(APPEND _cmake_import_check_targets fairseq2n::fairseq2n )
list(APPEND _cmake_import_check_files_for_fairseq2n::fairseq2n "${_IMPORT_PREFIX}/lib/libfairseq2n.so.0.1.0" )
