...
class COPASIHookeJeeves(COPASIOptimisationMethod):
    ITERATION_LIMIT = "Iteration Limit"
    TOLERANCE = "Tolerance"
    RHO = "Rho"

    def __init__(self):
        super(COPASIHookeJeeves, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASIHookeJeeves.ITERATION_LIMIT, 50),
            COPASISolverParameter(COPASIHookeJeeves.TOLERANCE, 1e-05),
            COPASISolverParameter(COPASIHookeJeeves.RHO, 0.2)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_HookeJeeves)
