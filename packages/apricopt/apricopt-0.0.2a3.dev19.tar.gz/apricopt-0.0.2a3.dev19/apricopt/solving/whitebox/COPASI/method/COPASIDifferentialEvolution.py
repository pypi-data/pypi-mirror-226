...
class COPASIDifferentialEvolution(COPASIOptimisationMethod):
    ...
    def __init__(self):
        super(COPASIDifferentialEvolution, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASIDifferentialEvolution.NUMBER_OF_GENERATIONS, 2000),
            COPASISolverParameter(COPASIDifferentialEvolution.POPULATION_SIZE, 10)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_DifferentialEvolution)
