...
class COPASIPraxis(COPASIOptimisationMethod):
    TOLERANCE = "Tolerance"

    def __init__(self):
        super(COPASIPraxis, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASIPraxis.TOLERANCE, 1e-05)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_Praxis)
