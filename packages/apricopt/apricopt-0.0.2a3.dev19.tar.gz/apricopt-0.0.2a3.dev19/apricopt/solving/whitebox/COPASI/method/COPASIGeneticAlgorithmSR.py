...
class COPASIGeneticAlgorithmSR(COPASIOptimisationMethod):
    NUMBER_OF_GENERATIONS = "Number of Generations"
    POPULATION_SIZE = "Population Size"
    MUTATION_VARIANCE = "Mutation Variance"
    SEED = "Seed"
    ...
    def __init__(self):
        super(COPASIGeneticAlgorithmSR, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASIGeneticAlgorithmSR.NUMBER_OF_GENERATIONS, 200),
            COPASISolverParameter(COPASIGeneticAlgorithmSR.POPULATION_SIZE, 20),
            COPASISolverParameter(COPASIGeneticAlgorithmSR.PF, 0.475)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_GeneticAlgorithmSR)
