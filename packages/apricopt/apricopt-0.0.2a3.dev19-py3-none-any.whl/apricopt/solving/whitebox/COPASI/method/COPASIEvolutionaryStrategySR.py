...
class COPASIEvolutionaryStrategySR(COPASIOptimisationMethod):
    ...
    def __init__(self):
        super(COPASIEvolutionaryStrategySR, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASIEvolutionaryStrategySR.NUMBER_OF_GENERATIONS, 200),
            COPASISolverParameter(COPASIEvolutionaryStrategySR.POPULATION_SIZE, 20),
            COPASISolverParameter(COPASIEvolutionaryStrategySR.PF, 0.475)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_SRES)
