...
class COPASIScatterSearch(COPASIOptimisationMethod):
    ...
    def __init__(self):
        super(COPASIScatterSearch, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASIScatterSearch.NUMBER_OF_ITERATIONS, 200)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_ScatterSearch)
