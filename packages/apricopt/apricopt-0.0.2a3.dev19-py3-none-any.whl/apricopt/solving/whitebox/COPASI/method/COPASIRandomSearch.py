...
class COPASIRandomSearch(COPASIOptimisationMethod):
    NUMBER_OF_ITERATIONS = "Number of Iterations"
    RANDOM_NUMBER_GENERATOR = "Random Number Generator"
    SEED = "Seed"

    def __init__(self):
        super(COPASIRandomSearch, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASIRandomSearch.NUMBER_OF_ITERATIONS, 100000)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_RandomSearch)
