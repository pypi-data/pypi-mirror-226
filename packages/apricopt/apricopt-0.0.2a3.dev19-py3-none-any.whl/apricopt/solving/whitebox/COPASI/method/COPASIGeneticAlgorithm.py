...
class COPASIGeneticAlgorithm(COPASIOptimisationMethod):
    ...
    def __init__(self):
        super(COPASIGeneticAlgorithm, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASIGeneticAlgorithm.NUMBER_OF_GENERATIONS, 200),
            COPASISolverParameter(COPASIGeneticAlgorithm.POPULATION_SIZE, 20)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_GeneticAlgorithm)
