...
class COPASISteepestDescent(COPASIOptimisationMethod):
    ITERATION_LIMIT = 'Iteration Limit'
    TOLERANCE = 'Tolerance'

    def __init__(self):
        super(COPASISteepestDescent, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter(COPASISteepestDescent.ITERATION_LIMIT, 100),
            COPASISolverParameter(COPASISteepestDescent.TOLERANCE, 1e-6)
        ]
    ...
    def set_parameters_configuration(self, opt_task: COPASI.COptTask,
        ...
        self.opt_task.setMethodType(COPASI.CTaskEnum.Method_SteepestDescent)
