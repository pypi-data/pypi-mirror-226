...
# pd_data_frame = pd.DataFrame(convert_json_to_data_frame("nuscene_US_rainy_clear_engg_embedding.json", "train-data")).to_pickle('train-data-nuscene_US_rainy_clear_engg_embedding.pkl')
...
test_session = TestSession(project_name="testingProject",run_name= f"{dataset_}-run-8-aug-{version}")

#create test_ds object of Dataset instance
test_ds = Dataset(test_session=test_session, name=f"{dataset_}-dataset-7-aug-{version}")
