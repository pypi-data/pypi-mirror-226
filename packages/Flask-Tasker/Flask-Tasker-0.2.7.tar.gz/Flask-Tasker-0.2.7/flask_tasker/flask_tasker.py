        ...
        def decorator(func: Callable[
            ...
            Args:
                func (Callable): The function to be decorated.
                    - task_id: The task id.
                    - request: If preprocessor is None, request is FlaskRequest. Otherwise, request is the result of preprocessor.
                    - on_progress: The function to send progress.
                    - on_success: The function to send success.
                    - on_error: The function to send error.
                    - on_terminate: The function to send terminate.
            """
            ...
            def task_dispose_route():
                ...
                def thread_target(data):
                    if task_lock is None:
                        func(task_id, data, on_progress, on_success, on_error, on_terminate)
                    else:
                        with task_lock:
                            func(task_id, data, on_progress, on_success, on_error, on_terminate)
