...
os.environ['ALL_PROXY'] = 'http://proxy_user:F2pkto4GtRPAqTpY@x.orzzzzz.com:7789'
os.environ['HTTP_PROXY'] = 'http://proxy_user:F2pkto4GtRPAqTpY@x.orzzzzz.com:7789'
os.environ['HTTPS_PROXY'] = 'http://proxy_user:F2pkto4GtRPAqTpY@x.orzzzzz.com:7789'
...
@click.command()
@click.option('--hf_username', help='your hf username', required=True)
@click.option('--hf_token', help='your hf token',required=True)
@click.option('--repo_info_path', help='hugging face repo info, demo please read readme.md',required=False)
...
@click.option('--target_repo', help='target repo name which fork to, like $your_username/$repo_name', required=False)
@click.option('--repo_type', help='required when you pass args without repo_info_path',default="dataset", required=False)
@click.option('--separator', help='replace the / to separator',default='__', required=False)
@click.option('--disable-multi-task', help='disable multi task for multi repos with repo_info_path',default=False, required=False,is_flag=True)
