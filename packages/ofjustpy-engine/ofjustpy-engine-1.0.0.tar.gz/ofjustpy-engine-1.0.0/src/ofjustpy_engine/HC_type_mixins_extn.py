...
class ButtonMixin:
    ...
    def autofocus(self, value):
        ...
        elif "autofocus" in self.domDict.attrs:
    ...
    def disabled(self, value):
        ...
        elif "disabled" in self.domDict.attrs:
    ...
    def form(self, value):
        if value is not None:
            self.attrs["form"] = value
        elif "form" in self.domDict.attrs:
            del self.attrs["form"]
    ...
    def formaction(self, value):
        ...
        elif "formaction" in self.domDict.attrs:
    ...
    def formenctype(self, value):
        ...
        elif "formenctype" in self.domDict.attrs:
    ...
    def formmethod(self, value):
        ...
        elif "formmethod" in self.domDict.attrs:
    ...
    def formnovalidate(self, value):
        ...
        elif "formnovalidate" in self.domDict.attrs:
...
class TextareaMixin(InputMixin):
    ...
    def cols(self, value):
        ...
        elif "cols" in self.domDict.attrs:
            del self.attrs["cols"]
    ...
    def rows(self, value):
        ...
        elif "rows" in self.domDict.attrs:
            del self.attrs["rows"]
...
class ImgMixin:
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "alt" in kwargs:
            self.domDict.attrs["alt"] = kwargs["alt"]
        if "crossorigin" in kwargs:
            self.domDict.attrs["crossorigin"] = kwargs["crossorigin"]
        if "height" in kwargs:
            self.domDict.attrs["height"] = kwargs["height"]
        if "ismap" in kwargs:
            self.domDict.attrs["ismap"] = kwargs["ismap"]
        if "longdesc" in kwargs:
            self.domDict.attrs["longdesc"] = kwargs["longdesc"]
        if "sizes" in kwargs:
            self.domDict.attrs["sizes"] = kwargs["sizes"]
        if "src" in kwargs:
            self.domDict.attrs["src"] = kwargs["src"]
        if "srcset" in kwargs:
            self.domDict.attrs["srcset"] = kwargs["srcset"]
        if "usemap" in kwargs:
            self.domDict.attrs["usemap"] = kwargs["usemap"]
        if "width" in kwargs:
            self.domDict.attrs["width"] = kwargs["width"]
    ...
    def alt(self):
        ...
        """
        return self.domDict.attrs.get("alt", None)

    @alt.setter
    def alt(self, value):
        if value is None:
            self.domDict.attrs.pop("alt", None)
        else:
            self.domDict.attrs["alt"] = value
    ...
    def crossorigin(self):
        ...
        """
        return self.domDict.attrs.get("crossorigin", None)

    @crossorigin.setter
    def crossorigin(self, value):
        if value is None:
            self.domDict.attrs.pop("crossorigin", None)
        else:
            self.domDict.attrs["crossorigin"] = value
    ...
    def height(self):
        ...
        """
        return self.domDict.attrs.get("height", None)

    @height.setter
    def height(self, value):
        if value is None:
            self.domDict.attrs.pop("height", None)
        else:
            self.domDict.attrs["height"] = value
    ...
    def ismap(self):
        ...
        """
        return self.domDict.attrs.get("ismap", None)

    @ismap.setter
    def ismap(self, value):
        if value is None:
            self.domDict.attrs.pop("ismap", None)
        else:
            self.domDict.attrs["ismap"] = value
    ...
    def longdesc(self):
        ...
        """
        return self.domDict.attrs.get("longdesc", None)

    @longdesc.setter
    def longdesc(self, value):
        if value is None:
            self.domDict.attrs.pop("longdesc", None)
        else:
            self.domDict.attrs["longdesc"] = value
...
class FormMixin:
    ...
    def __init__(self, **kwargs):
        ...
        for attr in [
            ...
            if attr in kwargs:
                self.domDict.attrs[attr] = kwargs[attr]
    ...
    def accept_charset(self):
        ...
        """
        return self.domDict.attrs.get("accept-charset", None)

    @accept_charset.setter
    def accept_charset(self, value):
        if value is not None:
            self.domDict.attrs["accept-charset"] = value
        elif "accept-charset" in self.domDict.attrs:
            del self.domDict.attrs["accept-charset"]
    ...
    def action(self):
        ...
        """
        return self.domDict.attrs.get("action", None)

    @action.setter
    def action(self, value):
        if value is not None:
            self.domDict.attrs["action"] = value
        elif "action" in self.domDict.attrs:
            del self.domDict.attrs["action"]
    ...
    def autocomplete(self):
        ...
        """
        return self.domDict.attrs.get("autocomplete", None)

    @autocomplete.setter
    def autocomplete(self, value):
        if value is not None:
            self.domDict.attrs["autocomplete"] = value
        elif "autocomplete" in self.domDict.attrs:
            del self.domDict.attrs["autocomplete"]
    ...
    def enctype(self):
        ...
        """
        return self.domDict.attrs.get("enctype", None)

    @enctype.setter
    def enctype(self, value):
        if value is not None:
            self.domDict.attrs["enctype"] = value
        elif "enctype" in self.domDict.attrs:
            del self.domDict.attrs["enctype"]
    ...
    def method(self):
        ...
        """
        return self.domDict.attrs.get("method", None)

    @method.setter
    def method(self, value):
        if value is not None:
            self.domDict.attrs["method"] = value
        elif "method" in self.domDict.attrs:
            del self.domDict.attrs["method"]
    ...
    def name(self):
        ...
        """
        return self.domDict.attrs.get("name", None)

    @name.setter
    def name(self, value):
        if value is not None:
            self.domDict.attrs["name"] = value
        elif "name" in self.domDict.attrs:
            del self.domDict.attrs["name"]
    ...
    def novalidate(self):
        ...
        """
        return self.domDict.attrs.get("novalidate", None)

    @novalidate.setter
    def novalidate(self, value):
        if value is not None:
            self.domDict.attrs["novalidate"] = value
        elif "novalidate" in self.domDict.attrs:
            del self.domDict.attrs["novalidate"]
    ...
    def target(self):
        ...
        """
        return self.domDict.attrs.get("target", None)

    @target.setter
    def target(self, value):
        if value is not None:
            self.domDict.attrs["target"] = value
        elif "target" in self.domDict.attrs:
            del self.domDict.attrs["target"]
