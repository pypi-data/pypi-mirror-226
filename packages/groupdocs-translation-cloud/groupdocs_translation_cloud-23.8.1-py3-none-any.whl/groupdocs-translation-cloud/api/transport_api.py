...
class TransportApi(object):
    ...
    @validate_arguments
    def markdown_post(self, source_language : constr(strict=True, min_length=1), target_languages : conlist(StrictStr), output_format : constr(strict=True, min_length=1), file : Optional[Union[StrictBytes, StrictStr]] = None, original_file_name : Optional[StrictStr] = None, url : Optional[StrictStr] = None, origin : Optional[StrictStr] = None, saving_mode : Optional[StrictStr] = None, front_matter_list : Optional[conlist(conlist(StrictStr))] = None, **kwargs) -> StatusResponse:  # noqa: E501
        ...
        :type source_language: str
        :param target_languages: (required)
        :type target_languages: List[str]
        :param output_format: (required)
        :type output_format: str
        :param file:
        :type file: bytearray
        :param original_file_name:
    ...
    @validate_arguments
    def markdown_post_with_http_info(self, source_language : constr(strict=True, min_length=1), target_languages : conlist(StrictStr), output_format : constr(strict=True, min_length=1), file : Optional[Union[StrictBytes, StrictStr]] = None, original_file_name : Optional[StrictStr] = None, url : Optional[StrictStr] = None, origin : Optional[StrictStr] = None, saving_mode : Optional[StrictStr] = None, front_matter_list : Optional[conlist(conlist(StrictStr))] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """markdown_post  # noqa: E501
