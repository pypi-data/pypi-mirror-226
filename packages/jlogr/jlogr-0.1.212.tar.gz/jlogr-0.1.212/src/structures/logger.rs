...
impl Logger {
    ...
    #[pyo3(name = "push_log_from_log")]
    #[pyo3(text_signature = "(log)")]
    #[pyo3(signature = (log))]
    pub fn push_log_from_log(&mut self, log: Log) {
        self.logs_buffer.push(log);
    }

    #[pyo3(name = "display_list_of_logs")]
    #[pyo3(text_signature = "()")]
    #[pyo3(signature = ())]
