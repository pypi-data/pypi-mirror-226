...
@click.option("--builder", help="The builder to use", type=str, default=None)
def stage(build, url, builder):
    ...
    of the app that is run agains the local arkitekt instance
    ...
    builder = builder or build.builder
    ...
    if (
        "No manifest found" in docker_run.stderr
        or "No manifest found" in docker_run.stdout
    ):
        raise click.ClickException(
