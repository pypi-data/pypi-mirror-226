...
class site():
    ...
    def publish_watchlist_report(self):
        ...
        for user_name in user_name_list:
            ...
            detail_df = detail_df[['symbol', 'last_price', '5 days change %', '10 days change %', '30 days change %', 'support', 'resistence', 'trend', 'earning', 'forward_PE', 'rating', 'bb_pos', 'rsi', 'macd', 'mfi', 'HV', 'IV1', 'IV2', 'IV3']]

            detail_df.sort_values('5 days change %', inplace=True)

            summary_df = detail_df[['symbol', 'last_price', '5 days change %', '10 days change %', '30 days change %', 'HV', 'IV1', 'IV2', 'IV3']]          
