...
def build_requests(method: str, urls: list[str], debug: bool, **kwargs) -> Generator[Request]:
    """
...
def send(method: str, urls: list[str], debug: bool = False, **kwargs) -> Generator[partial]:
    """
    ...
    """
    httpx_send = kwargs.pop('send', {})

    async def fn(client: AsyncClient, r: dict) -> Response:
        return await backoff(client.send, r, **httpx_send)
