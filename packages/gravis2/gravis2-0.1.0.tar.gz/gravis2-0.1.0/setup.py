...
setup(
    ...
    author='Jonathan',
    author_email='jon-dev@tine.dev',
    description='Interactive graph visualizations with Python and HTML/CSS/JS. This is a clone of the gravis package with some stylistic updates.',
    #long_description=load_long_description(PKG_DIR),
    url='https://github.com/jonschneid7/gravis2',
