...
def async_io(func: typing.Callable[P, T]) -> typing.Callable[P, typing.Coroutine[T, Any, Any]]:
    """
...
def async_cpu(func: typing.Callable[P, T]) -> typing.Callable[P, typing.Coroutine[T, Any, Any]]:
    """
    ...
    async def wrapper(*args: P.args, **kwargs: P.kwargs) -> T:
        with ProcessPoolExecutor() as pool:
            try:
                ...
                return await asyncio.get_event_loop().run_in_executor(pool, func, *args, **kwargs)
    return wrapper
