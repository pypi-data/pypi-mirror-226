...
#### Usage Example
```python
data_clener.read_data("file_path")
```
...
data_clener.col_missing_value("col_name")
...
data_cleaner.drop("column")

```	
##### OR 
```python

data_cleaner.drop(["column_1","column_2"])
...
data_cleaner.outliers_single("column")
...
data_cleaner.cont_to_cont("col1","col2")

```
##### OR
```python

data_cleaner.cont_to_cont("col1",["col2","col3"])
...
data_cleaner.cont_to_cont(["col1","col2"],["col3","col4"])
...
data_cleaner.cat_to_cat("col1","col2")

```
##### OR
```python

data_cleaner.cat_to_cat("col1",["col2","col3"])
...
data_cleaner.cat_to_cat(["col1","col2"],["col3","col4"])
...
data_cleaner.countplot("col1","col2")
...
data_cleaner.contingency_table("col1","col2")
...
data_cleaner.Chi_square("col1","col2")
...
data_cleaner.combined_boxplot("col1", "col2")
...
data_cleaner.singleAnova("col1", "col2")
...
data_cleaner.cont_to_cat("col1","col2")

```
##### OR
```python

data_cleaner.cont_to_cat("col1",["col2","col3"])
...
data_cleaner.cont_to_cat(["col1","col2"],["col3","col4"])
