...
def load_model(
    ...
    model = AutoModelForCausalLM.from_pretrained(name_or_path,cache_dir=MODEL_CACHE_DIR, torch_dtype=torch.float16, low_cpu_mem_usage=True, device_map="auto",load_in_8bit=load_in_8bit)
