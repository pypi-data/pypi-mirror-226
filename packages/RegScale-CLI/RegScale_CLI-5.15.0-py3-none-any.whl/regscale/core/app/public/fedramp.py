...
def post_implementations(
    app: Application, ssp_obj: dict, regscale_ssp: dict, mapping: dict, ctrl_roles: dict
) -> None:
    """
...
def post_leveraged_authorizations(
    ...
    for la in data:
        leveragedAuth = LeveragedAuthorizations(
        ...
        LeveragedAuthorizations.insert_leveraged_authorizations(app, leveragedAuth)
...
def process_fedramp_docx(
    ...
    regscale_ssp = regscale_ssp.dict()
