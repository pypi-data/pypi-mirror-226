...
class DnsClient(object):
    ...
    def change_resolver_compartment(self, resolver_id, change_resolver_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/change_resolver_compartment.py.html>`__ to see an example of how to use change_resolver_compartment API.
        """
    ...
    def change_steering_policy_compartment(self, steering_policy_id, change_steering_policy_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/change_steering_policy_compartment.py.html>`__ to see an example of how to use change_steering_policy_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_tsig_key_compartment(self, tsig_key_id, change_tsig_key_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/change_tsig_key_compartment.py.html>`__ to see an example of how to use change_tsig_key_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_view_compartment(self, view_id, change_view_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/change_view_compartment.py.html>`__ to see an example of how to use change_view_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_zone_compartment(self, zone_id, change_zone_compartment_details, **kwargs):
        ...
        **Note:** All SteeringPolicyAttachment objects associated with this zone will also be moved into
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/change_zone_compartment.py.html>`__ to see an example of how to use change_zone_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_resolver_endpoint(self, resolver_id, create_resolver_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/create_resolver_endpoint.py.html>`__ to see an example of how to use create_resolver_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['resolverId']
    ...
    def create_steering_policy(self, create_steering_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/create_steering_policy.py.html>`__ to see an example of how to use create_steering_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_steering_policy_attachment(self, create_steering_policy_attachment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/create_steering_policy_attachment.py.html>`__ to see an example of how to use create_steering_policy_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_tsig_key(self, create_tsig_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/create_tsig_key.py.html>`__ to see an example of how to use create_tsig_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_view(self, create_view_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/create_view.py.html>`__ to see an example of how to use create_view API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/views"
    ...
    def create_zone(self, create_zone_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/create_zone.py.html>`__ to see an example of how to use create_zone API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/zones"
    ...
    def create_zone_from_zone_file(self, compartment_id, create_zone_from_zone_file_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/create_zone_from_zone_file.py.html>`__ to see an example of how to use create_zone_from_zone_file API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_domain_records(self, zone_name_or_id, domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/delete_domain_records.py.html>`__ to see an example of how to use delete_domain_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_resolver_endpoint(self, resolver_id, resolver_endpoint_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/delete_resolver_endpoint.py.html>`__ to see an example of how to use delete_resolver_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_rr_set(self, zone_name_or_id, domain, rtype, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/delete_rr_set.py.html>`__ to see an example of how to use delete_rr_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_steering_policy(self, steering_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/delete_steering_policy.py.html>`__ to see an example of how to use delete_steering_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['steeringPolicyId']
    ...
    def delete_steering_policy_attachment(self, steering_policy_attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/delete_steering_policy_attachment.py.html>`__ to see an example of how to use delete_steering_policy_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_tsig_key(self, tsig_key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/delete_tsig_key.py.html>`__ to see an example of how to use delete_tsig_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['tsigKeyId']
    ...
    def delete_view(self, view_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/delete_view.py.html>`__ to see an example of how to use delete_view API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['viewId']
    ...
    def delete_zone(self, zone_name_or_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/delete_zone.py.html>`__ to see an example of how to use delete_zone API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_domain_records(self, zone_name_or_id, domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_domain_records.py.html>`__ to see an example of how to use get_domain_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId', 'domain']
        resource_path = "/zones/{zoneNameOrId}/records/{domain}"
    ...
    def get_resolver(self, resolver_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_resolver.py.html>`__ to see an example of how to use get_resolver API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['resolverId']
    ...
    def get_resolver_endpoint(self, resolver_id, resolver_endpoint_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_resolver_endpoint.py.html>`__ to see an example of how to use get_resolver_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['resolverId', 'resolverEndpointName']
        resource_path = "/resolvers/{resolverId}/endpoints/{resolverEndpointName}"
    ...
    def get_rr_set(self, zone_name_or_id, domain, rtype, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_rr_set.py.html>`__ to see an example of how to use get_rr_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId', 'domain', 'rtype']
        resource_path = "/zones/{zoneNameOrId}/records/{domain}/{rtype}"
    ...
    def get_steering_policy(self, steering_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_steering_policy.py.html>`__ to see an example of how to use get_steering_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['steeringPolicyId']
        resource_path = "/steeringPolicies/{steeringPolicyId}"
    ...
    def get_steering_policy_attachment(self, steering_policy_attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_steering_policy_attachment.py.html>`__ to see an example of how to use get_steering_policy_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['steeringPolicyAttachmentId']
        resource_path = "/steeringPolicyAttachments/{steeringPolicyAttachmentId}"
    ...
    def get_tsig_key(self, tsig_key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_tsig_key.py.html>`__ to see an example of how to use get_tsig_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['tsigKeyId']
        resource_path = "/tsigKeys/{tsigKeyId}"
    ...
    def get_view(self, view_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_view.py.html>`__ to see an example of how to use get_view API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['viewId']
        resource_path = "/views/{viewId}"
    ...
    def get_zone(self, zone_name_or_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_zone.py.html>`__ to see an example of how to use get_zone API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId']
        resource_path = "/zones/{zoneNameOrId}"
    ...
    def get_zone_content(self, zone_name_or_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_zone_content.py.html>`__ to see an example of how to use get_zone_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId']
    ...
    def get_zone_records(self, zone_name_or_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/get_zone_records.py.html>`__ to see an example of how to use get_zone_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId']
    ...
    def list_resolver_endpoints(self, resolver_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/list_resolver_endpoints.py.html>`__ to see an example of how to use list_resolver_endpoints API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['resolverId']
        resource_path = "/resolvers/{resolverId}/endpoints"
    ...
    def list_resolvers(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/list_resolvers.py.html>`__ to see an example of how to use list_resolvers API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_steering_policies(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/list_steering_policies.py.html>`__ to see an example of how to use list_steering_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/steeringPolicies"
    ...
    def list_steering_policy_attachments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/list_steering_policy_attachments.py.html>`__ to see an example of how to use list_steering_policy_attachments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/steeringPolicyAttachments"
    ...
    def list_tsig_keys(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/list_tsig_keys.py.html>`__ to see an example of how to use list_tsig_keys API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/tsigKeys"
    ...
    def list_views(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/list_views.py.html>`__ to see an example of how to use list_views API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/views"
    ...
    def list_zone_transfer_servers(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/list_zone_transfer_servers.py.html>`__ to see an example of how to use list_zone_transfer_servers API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_zones(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/list_zones.py.html>`__ to see an example of how to use list_zones API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/zones"
    ...
    def patch_domain_records(self, zone_name_or_id, domain, patch_domain_records_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/patch_domain_records.py.html>`__ to see an example of how to use patch_domain_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId', 'domain']
        resource_path = "/zones/{zoneNameOrId}/records/{domain}"
    ...
    def patch_rr_set(self, zone_name_or_id, domain, rtype, patch_rr_set_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/patch_rr_set.py.html>`__ to see an example of how to use patch_rr_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId', 'domain', 'rtype']
        resource_path = "/zones/{zoneNameOrId}/records/{domain}/{rtype}"
    ...
    def patch_zone_records(self, zone_name_or_id, patch_zone_records_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/patch_zone_records.py.html>`__ to see an example of how to use patch_zone_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId']
        resource_path = "/zones/{zoneNameOrId}/records"
    ...
    def update_domain_records(self, zone_name_or_id, domain, update_domain_records_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_domain_records.py.html>`__ to see an example of how to use update_domain_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId', 'domain']
        resource_path = "/zones/{zoneNameOrId}/records/{domain}"
    ...
    def update_resolver(self, resolver_id, update_resolver_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_resolver.py.html>`__ to see an example of how to use update_resolver API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['resolverId']
        resource_path = "/resolvers/{resolverId}"
    ...
    def update_resolver_endpoint(self, resolver_id, resolver_endpoint_name, update_resolver_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_resolver_endpoint.py.html>`__ to see an example of how to use update_resolver_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['resolverId', 'resolverEndpointName']
        resource_path = "/resolvers/{resolverId}/endpoints/{resolverEndpointName}"
    ...
    def update_rr_set(self, zone_name_or_id, domain, rtype, update_rr_set_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_rr_set.py.html>`__ to see an example of how to use update_rr_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId', 'domain', 'rtype']
        resource_path = "/zones/{zoneNameOrId}/records/{domain}/{rtype}"
    ...
    def update_steering_policy(self, steering_policy_id, update_steering_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_steering_policy.py.html>`__ to see an example of how to use update_steering_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['steeringPolicyId']
        resource_path = "/steeringPolicies/{steeringPolicyId}"
    ...
    def update_steering_policy_attachment(self, steering_policy_attachment_id, update_steering_policy_attachment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_steering_policy_attachment.py.html>`__ to see an example of how to use update_steering_policy_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['steeringPolicyAttachmentId']
        resource_path = "/steeringPolicyAttachments/{steeringPolicyAttachmentId}"
    ...
    def update_tsig_key(self, tsig_key_id, update_tsig_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_tsig_key.py.html>`__ to see an example of how to use update_tsig_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['tsigKeyId']
        resource_path = "/tsigKeys/{tsigKeyId}"
    ...
    def update_view(self, view_id, update_view_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_view.py.html>`__ to see an example of how to use update_view API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['viewId']
        resource_path = "/views/{viewId}"
    ...
    def update_zone(self, zone_name_or_id, update_zone_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_zone.py.html>`__ to see an example of how to use update_zone API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId']
        resource_path = "/zones/{zoneNameOrId}"
    ...
    def update_zone_records(self, zone_name_or_id, update_zone_records_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/dns/update_zone_records.py.html>`__ to see an example of how to use update_zone_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zoneNameOrId']
        resource_path = "/zones/{zoneNameOrId}/records"
