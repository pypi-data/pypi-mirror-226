...
class BdsClient(object):
    ...
    def activate_bds_metastore_configuration(self, bds_instance_id, metastore_config_id, activate_bds_metastore_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/activate_bds_metastore_configuration.py.html>`__ to see an example of how to use activate_bds_metastore_configuration API.
        """
    ...
    def add_auto_scaling_configuration(self, bds_instance_id, add_auto_scaling_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/add_auto_scaling_configuration.py.html>`__ to see an example of how to use add_auto_scaling_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def add_block_storage(self, bds_instance_id, add_block_storage_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/add_block_storage.py.html>`__ to see an example of how to use add_block_storage API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def add_cloud_sql(self, bds_instance_id, add_cloud_sql_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/add_cloud_sql.py.html>`__ to see an example of how to use add_cloud_sql API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def add_kafka(self, bds_instance_id, add_kafka_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/add_kafka.py.html>`__ to see an example of how to use add_kafka API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def add_master_nodes(self, bds_instance_id, add_master_nodes_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/add_master_nodes.py.html>`__ to see an example of how to use add_master_nodes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def add_utility_nodes(self, bds_instance_id, add_utility_nodes_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/add_utility_nodes.py.html>`__ to see an example of how to use add_utility_nodes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def add_worker_nodes(self, bds_instance_id, add_worker_nodes_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/add_worker_nodes.py.html>`__ to see an example of how to use add_worker_nodes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def change_bds_instance_compartment(self, bds_instance_id, change_bds_instance_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/change_bds_instance_compartment.py.html>`__ to see an example of how to use change_bds_instance_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def change_shape(self, bds_instance_id, change_shape_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/change_shape.py.html>`__ to see an example of how to use change_shape API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def create_bds_api_key(self, bds_instance_id, create_bds_api_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/create_bds_api_key.py.html>`__ to see an example of how to use create_bds_api_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def create_bds_instance(self, create_bds_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/create_bds_instance.py.html>`__ to see an example of how to use create_bds_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_bds_metastore_configuration(self, bds_instance_id, create_bds_metastore_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/create_bds_metastore_configuration.py.html>`__ to see an example of how to use create_bds_metastore_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def delete_bds_api_key(self, bds_instance_id, api_key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/delete_bds_api_key.py.html>`__ to see an example of how to use delete_bds_api_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_bds_instance(self, bds_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/delete_bds_instance.py.html>`__ to see an example of how to use delete_bds_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def delete_bds_metastore_configuration(self, bds_instance_id, metastore_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/delete_bds_metastore_configuration.py.html>`__ to see an example of how to use delete_bds_metastore_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId', 'metastoreConfigId']
    ...
    def execute_bootstrap_script(self, bds_instance_id, execute_bootstrap_script_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/execute_bootstrap_script.py.html>`__ to see an example of how to use execute_bootstrap_script API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def get_auto_scaling_configuration(self, bds_instance_id, auto_scaling_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/get_auto_scaling_configuration.py.html>`__ to see an example of how to use get_auto_scaling_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_bds_api_key(self, bds_instance_id, api_key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/get_bds_api_key.py.html>`__ to see an example of how to use get_bds_api_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId', 'apiKeyId']
        resource_path = "/bdsInstances/{bdsInstanceId}/apiKeys/{apiKeyId}"
    ...
    def get_bds_instance(self, bds_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/get_bds_instance.py.html>`__ to see an example of how to use get_bds_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
        resource_path = "/bdsInstances/{bdsInstanceId}"
    ...
    def get_bds_metastore_configuration(self, bds_instance_id, metastore_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/get_bds_metastore_configuration.py.html>`__ to see an example of how to use get_bds_metastore_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId', 'metastoreConfigId']
        resource_path = "/bdsInstances/{bdsInstanceId}/metastoreConfigs/{metastoreConfigId}"
    ...
    def get_os_patch_details(self, bds_instance_id, os_patch_version, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/get_os_patch_details.py.html>`__ to see an example of how to use get_os_patch_details API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def install_os_patch(self, bds_instance_id, install_os_patch_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/install_os_patch.py.html>`__ to see an example of how to use install_os_patch API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def install_patch(self, bds_instance_id, install_patch_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/install_patch.py.html>`__ to see an example of how to use install_patch API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def list_auto_scaling_configurations(self, compartment_id, bds_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_auto_scaling_configurations.py.html>`__ to see an example of how to use list_auto_scaling_configurations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_bds_api_keys(self, bds_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_bds_api_keys.py.html>`__ to see an example of how to use list_bds_api_keys API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
        resource_path = "/bdsInstances/{bdsInstanceId}/apiKeys"
    ...
    def list_bds_instances(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_bds_instances.py.html>`__ to see an example of how to use list_bds_instances API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_bds_metastore_configurations(self, bds_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_bds_metastore_configurations.py.html>`__ to see an example of how to use list_bds_metastore_configurations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
        resource_path = "/bdsInstances/{bdsInstanceId}/metastoreConfigs"
    ...
    def list_os_patches(self, bds_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_os_patches.py.html>`__ to see an example of how to use list_os_patches API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def list_patch_histories(self, bds_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_patch_histories.py.html>`__ to see an example of how to use list_patch_histories API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def list_patches(self, bds_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_patches.py.html>`__ to see an example of how to use list_patches API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def remove_auto_scaling_configuration(self, bds_instance_id, auto_scaling_configuration_id, remove_auto_scaling_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/remove_auto_scaling_configuration.py.html>`__ to see an example of how to use remove_auto_scaling_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId', 'autoScalingConfigurationId']
    ...
    def remove_cloud_sql(self, bds_instance_id, remove_cloud_sql_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/remove_cloud_sql.py.html>`__ to see an example of how to use remove_cloud_sql API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def remove_kafka(self, bds_instance_id, remove_kafka_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/remove_kafka.py.html>`__ to see an example of how to use remove_kafka API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def remove_node(self, bds_instance_id, remove_node_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/remove_node.py.html>`__ to see an example of how to use remove_node API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def restart_node(self, bds_instance_id, restart_node_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/restart_node.py.html>`__ to see an example of how to use restart_node API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def start_bds_instance(self, bds_instance_id, start_bds_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/start_bds_instance.py.html>`__ to see an example of how to use start_bds_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def stop_bds_instance(self, bds_instance_id, stop_bds_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/stop_bds_instance.py.html>`__ to see an example of how to use stop_bds_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
    ...
    def test_bds_metastore_configuration(self, bds_instance_id, metastore_config_id, test_bds_metastore_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/test_bds_metastore_configuration.py.html>`__ to see an example of how to use test_bds_metastore_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId', 'metastoreConfigId']
    ...
    def test_bds_object_storage_connection(self, bds_instance_id, api_key_id, test_bds_object_storage_connection_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/test_bds_object_storage_connection.py.html>`__ to see an example of how to use test_bds_object_storage_connection API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId', 'apiKeyId']
    ...
    def update_auto_scaling_configuration(self, bds_instance_id, auto_scaling_configuration_id, update_auto_scaling_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/update_auto_scaling_configuration.py.html>`__ to see an example of how to use update_auto_scaling_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId', 'autoScalingConfigurationId']
        resource_path = "/bdsInstances/{bdsInstanceId}/autoScalingConfiguration/{autoScalingConfigurationId}"
    ...
    def update_bds_instance(self, bds_instance_id, update_bds_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/update_bds_instance.py.html>`__ to see an example of how to use update_bds_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId']
        resource_path = "/bdsInstances/{bdsInstanceId}"
    ...
    def update_bds_metastore_configuration(self, bds_instance_id, metastore_config_id, update_bds_metastore_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.110.2/bds/update_bds_metastore_configuration.py.html>`__ to see an example of how to use update_bds_metastore_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bdsInstanceId', 'metastoreConfigId']
        resource_path = "/bdsInstances/{bdsInstanceId}/metastoreConfigs/{metastoreConfigId}"
