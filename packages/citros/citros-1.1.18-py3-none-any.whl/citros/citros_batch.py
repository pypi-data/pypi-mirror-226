...
class citros_batch():
    ...
    def create_batch(self, batch_id, repo_id, simulation_name, gpu, cpu, memory, completions, 
                     user_commit, user_branch, citros_commit, citros_branch, 
                     name="", message="", parallelism=0, metadata={}):
        query = """
        ...
        result = self.citros.gql_execute(query, variable_values={
            ...
            "batchRun": {
                ...
                "citros_branch": citros_branch,
                "citros_commit": citros_commit,
