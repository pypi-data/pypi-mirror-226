...
class Citros:
    ...
    def run_simulation(self, sim_name, completions, timeout, remote):      
        ...
        storage_type = self.get_simulation_info(sim_name)['storage_type']
        ...
        if remote:
            batch_id = self.batch.create_batch(batch_id, self.repo_id, sim_name, gpu, cpu, mem, 
                                               storage_type, completions, user_commit, user_branch, 
                                               citros_commit, citros_branch, name=self._batch_name, 
                                               message=self._batch_message, metadata=self.events.otlp_context)
            return
