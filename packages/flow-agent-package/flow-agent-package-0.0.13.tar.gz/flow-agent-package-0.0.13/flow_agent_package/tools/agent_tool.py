...
class ArbitrationAgent:
  ...
  def __init__(self, arbitration_method, agent_connection, skills, history):
  ...
  def use_semantic_kernel(self, query):
    ...
    kernel.add_text_completion_service("dv", AzureChatCompletion("gpt-35-turbo", self.agent_connection.api_base, self.agent_connection.api_key))
...
def pick_tool_and_execute(
    ...
    config1: AgentSkillConfiguration,
    config2: AgentSkillConfiguration,
    config3: AgentSkillConfiguration
):
  ...
  agent_skills = []
  agent_skills.append(AgentSkill(config1, pf, subscription_id, resource_group_name, workspace_name))
  agent_skills.append(AgentSkill(config2, pf, subscription_id, resource_group_name, workspace_name))
  agent_skills.append(AgentSkill(config3, pf, subscription_id, resource_group_name, workspace_name))

  agent = ArbitrationAgent(arbitration_method, llm_connection, agent_skills, chat_history)
