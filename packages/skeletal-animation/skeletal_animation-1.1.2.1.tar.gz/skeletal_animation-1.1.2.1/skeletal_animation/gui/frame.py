if 0:  # remove errors in code editor
    from skeletal_animation.gui.init import *
import gh_utils
import gh_camera
import gh_renderer
...
from skeletal_animation.utils.loader import SERIALIZED_ANIMATION_PATH
...
def load_animator_1():
    ...
    try:
        ...
        file_not_found_message = (
            "File not found: "
            + str(SERIALIZED_ANIMATION_PATH)
            + animated_models[anim_1]
            + ".pkl. Element removed from list."
        )
