...
print(os.listdir(os.path.abspath("./skeletal_animation/utils")))

relative_path_to_config = "skeletal_animation/.config"
...
try:
    ...
    raise FileNotFoundError(f".config file not found at {os.path.abspath(path_to_config)}")
