...
walk_animator = load_fbx(os.path.join(RAW_ANIMATION_PATH, "walk.fbx"))
# Load the death animation from a FBX file
death_animator = load_fbx(os.path.join(RAW_ANIMATION_PATH, "death.fbx"))
...
serialize(clipped_animator, "walk_then_suddenly_die", SERIALIZED_ANIMATION_PATH)
