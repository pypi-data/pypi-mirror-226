...
class TestParameter(kuto.Case):
    ...
    @kuto.file_data(file='static/static.json')
    def test_json(self, param):
        print(param)

    @kuto.file_data(file='static/static.yml', key='names')
    def test_yaml(self, param):
        print(param)

    @kuto.file_data(file='static/static.csv')
    def test_csv(self, param):
        print(param)

    @kuto.file_data(file='static/static.xlsx', row=1)
