...
def create_scaffold(platform):
    ...
    create_folder(os.path.join(root_path, "test"))
    ...
    if platform == "android":
        # 新增安卓测试用例
        create_file(
            os.path.join(root_path, "test", "test_adr.py"),
        ...
        # 新增ios测试用例
        create_file(
            os.path.join(root_path, "test", "test_ios.py"),
            case_content_ios,
        )
    elif platform == "web":
        # 新增web测试用例
        create_file(
            os.path.join(root_path, "test", "test_web.py"),
            case_content_web,
        )
    elif platform == "api":
        # 新增接口测试用例
        create_file(
            os.path.join(root_path, "test", "test_api.py"),
            case_content_api,
        )
    else:
