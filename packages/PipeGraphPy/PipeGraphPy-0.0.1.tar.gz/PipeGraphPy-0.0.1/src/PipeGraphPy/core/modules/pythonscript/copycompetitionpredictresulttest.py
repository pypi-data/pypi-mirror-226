...
from PipeGraphPy.db.models import OnlineGraphsPredictRecordTB, PredictRecordTB
    ...
    def run(self):
        ...
        if os.path.isfile(filepath):
            if self.replace == "1":
                ...
                return
        if self.graph_ids:
            graph_info = models.GraphsTB.find(id=("in", self.graph_ids))
        else:
            graph_info = models.GraphsTB.find(
                    biz_id=self.biz_id,
