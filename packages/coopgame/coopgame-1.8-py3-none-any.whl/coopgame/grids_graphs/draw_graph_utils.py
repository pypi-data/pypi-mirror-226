...
from coopgame.gameTemplate import TransformMatrixProvider
...
class GraphDrawArgs:
    ...
    draw_transform_matrix: TransformMatrixProvider | np.ndarray = None
...
def draw_to_surface(surface: pygame.Surface ,
    ...
    if args.enabled_edge_args or args.disabled_edge_args:
        _draw_edges(
            ...
            draw_scale_matrix=args.draw_transform_matrix,
...
def _draw_edges(
    ...
    nutils.draw_lines(lines=line_args,
                      surface=surface,
                      draw_transform_matrix=draw_scale_matrix,
                      )
...
def draw_articulation_points(surface: pygame.Surface,
    ...
    scaled_pos = help.scaled_points([Vector2.from_tuple(node.pos) for node in articulation_points.keys()],
                                    transform_matrix=draw_transform_matrix)
