...
class InoDriveDiscoverWs(object):
    ...
    :Returns: **Object** - An Object that can Return Module Information over WebSocket.
    """
    ...
    def discover(self):
        """
        :Arguments: **self** *(Object)*: Refers to InoDriveDiscoverWs object, can also use an InoDrive Object with an established Connection Handle.
