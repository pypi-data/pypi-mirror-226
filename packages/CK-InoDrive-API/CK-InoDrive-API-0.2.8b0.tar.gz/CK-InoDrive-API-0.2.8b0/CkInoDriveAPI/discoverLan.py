...
def _get_network_interfaces_using_ifaddr(one_ip_per_adapter=False):
    """Return Client Network Interfaces with IP Addresses."""
...
def _discover_modules_on_netif(netif_ip_tuple, num_attempts=1, per_attempt_timeout=0.5, ma_sleep_min=0.2, ma_sleep_max=0.5):
    """Discover module(s) by parsing through Network Interface(s) with their attached IP Addresses."""
    modules_found = {}
...
def id_discover_lan(net_adapter_ip=None, num_attempts=2):
    ...
    :Arguments:
        ...
        * **num_attempts** *(Integer)*: (Optional) Number of attempts to retrieve Module Information. Defaults to 2 attempts. 
