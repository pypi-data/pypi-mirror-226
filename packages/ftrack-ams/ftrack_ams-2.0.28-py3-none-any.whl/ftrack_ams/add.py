    ...
    if existing_project is None:
        ...
        for artist in [int_artist, ext_artist, moving_artist]:
            if artist is not None:
                # TODO: have to check if the artist already has timetracking for this thingie.
                print(existing_project["children"])
                print(x["name"] for x in existing_project["children"])
