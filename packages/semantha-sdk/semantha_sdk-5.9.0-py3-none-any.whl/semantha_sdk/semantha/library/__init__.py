...
from semantha_sdk.model import Reference, Document
...
from semantha_sdk.semantha.tags import Tags
...
class Library:
    ...
    def upload_text(self, text: str):
        ...
        :return: the uploaded document
        """
        document = self.__reference_documents.post(text=text)[0]
        return LibraryDocument.from_document(
            self.__domain,
            document
        )
