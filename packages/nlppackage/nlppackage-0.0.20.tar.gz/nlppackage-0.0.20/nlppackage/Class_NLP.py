...
class NLP:
    def __init__(self):
        ...
        self.stopwords_fr = pd.read_csv('./data/stopWords_spacy_fr.csv',sep =';', encoding='utf-8')
        self.stopwords_fr = list(self.stopwords_fr['word'])
        self.stopwords_en = pd.read_csv('./data/stopWords_spacy_en.csv',sep =';', encoding='utf-8')
