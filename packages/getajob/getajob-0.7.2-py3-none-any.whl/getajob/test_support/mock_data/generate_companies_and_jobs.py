...
def generate_companies_and_jobs(num_companies: int, num_jobs_per_company: int):
    ...
    jobs_repo = JobsRepository(request_scope=request_scope, kafka=kafka_repo)
