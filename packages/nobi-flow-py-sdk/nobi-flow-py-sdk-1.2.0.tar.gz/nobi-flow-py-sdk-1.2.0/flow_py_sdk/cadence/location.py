...
class Location(ABC):
    ...
    def decode(
        cls, type_id: str
    ) -> Tuple["Location", str]: # qualified identifier
        pass
...
class AddressLocation(Location):
    ...
    def decode(
        cls, type_id: str
    ) -> Tuple["AddressLocation", str]: # qualified identifier
...
class FlowLocation(Location):
    ...
    def decode(
        cls, type_id: str
    ) -> Tuple["FlowLocation", str]: # qualified identifier
...
class StringLocation(Location):
    ...
    def decode(
        cls, type_id: str
    ) -> Tuple["StringLocation", str]: # qualified identifier
...
class ScriptLocation(Location):
    ...
    def decode(
        cls, type_id: str
    ) -> Tuple["ScriptLocation", str]: # qualified identifier
