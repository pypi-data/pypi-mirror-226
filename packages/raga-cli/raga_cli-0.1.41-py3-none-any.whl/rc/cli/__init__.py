...
import os
import subprocess
from rc.cli.utils import RctlValidSubprocessError, get_repo, valid_command_response
import tempfile
...
def valid_requirement():
    try:        
        ...
        raise RctlError('rc: error: git hub cli not found! Please install git hub cli from https://cli.github.com')
    try:        
        subprocess.run(['git', '--version'], capture_output=True)
    except OSError as err:        
        raise RctlError('rc: error: git not found! Please install git')
