...
@LastEditTime: 2023-08-03 18:10:44
...
class WeChatHelper:
    ...
    @classmethod
    def signature_v2(self, params, api_key):
        """
        :description:生成V2签名值
        :param params: 参数
        :param api_key: api密钥
...
class WeChatPayRequest(object):
    ...
    def get_prepay_id(self, unified_order_url, params):
        ...
        if prepay_id:
            ...
            return invoke_result_data
        params['sign'] = WeChatHelper.signature_v2(params, self.api_key)
    ...
    def create_order(self, pay_order_no, body, total_fee, spbill_create_ip, notify_url, open_id="", time_expire="", trade_type="JSAPI"):
        ...
        sign_again_params['sign'] = WeChatHelper.signature_v2(sign_again_params, self.api_key)
...
class WeChatPayReponse(object):
    ...
    def check_sign(self):
        ...
        del params['sign']
        sign = WeChatHelper.signature_v2(params, self.api_key)  # 本地签名
