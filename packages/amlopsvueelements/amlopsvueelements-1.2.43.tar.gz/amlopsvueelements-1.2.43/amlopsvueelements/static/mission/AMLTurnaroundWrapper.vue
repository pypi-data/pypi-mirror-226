                      ...
                      <div class="flex items-center w-full">
                        <img
                          :class="[
                            ...
                            {
                              'opacity-50 cursor-not-allowed': isDisabledService(
                                service.service,
                                serviceOptions
                              )
                            }
                    ...
                    <div class="flex justify-between gap-x-[0.5rem] items-center pr-1">
                      <UCheckboxWrapper
                        ...
                        :disabled="
                          ...
                          isDisabledService(service.service, serviceOptions)
                        "
                        class="!mb-0 d-flex"
                        size="24px"
                      />
...
const onRemoveService = (serviceIndex: number, serviceId: string) => {
  if (isDisabledService(serviceId, serviceOptions.value)) return
