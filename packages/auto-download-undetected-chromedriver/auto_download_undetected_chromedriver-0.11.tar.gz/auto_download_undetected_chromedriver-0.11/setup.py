...
long_description_content_type="text/markdown",
    #packages=['downloadunzip', 'flatten_any_dict_iterable_or_whatsoever', 'list_files_with_timestats', 'requests'],
    keywords=['chromedriver', 'selenium', 'patched', 'bot', 'automation'],
    classifiers=['Development Status :: 4 - Beta', 'Programming Language :: Python :: 3 :: Only', 'Programming Language :: Python :: 3.10', 'Topic :: Software Development :: Libraries :: Python Modules', 'Topic :: Utilities'],
    install_requires=['downloadunzip', 'flatten_any_dict_iterable_or_whatsoever', 'list_files_with_timestats', 'requests'],
