    ...
    def get_columns(self, connection, table_name, schema=None, **kw):
        ...
        query = """
            SELECT U.USER_NAME 'USER_NAME'
                ...
                , CASE WHEN (C.DATA_TYPE != 2 OR C.DATA_TYPE != 6) THEN C.PRECISION END 'CHAR_LENGTH_COL'
            ...
            LEFT OUTER JOIN SYSTEM_.SYS_COMMENTS_ COM ON T.TABLE_NAME = COM.TABLE_NAME AND C.COLUMN_NAME = COM.COLUMN_NAME
