...
from circles_local_database_python.connection import Connector
...
class GenericCRUD:
    ...
    @staticmethod
    def get_records_by_id(schema_name: str, table_name: str, id: str, id_col_name: str = "id"):
        """
    ...
    @staticmethod
    def get_records_by_where_condition(schema_name: str, table_name: str, where_condition: str = ""):
        """
    ...
    @staticmethod
    def insert(schema_name: str, table_name: str, json_data):
        """
    ...
    @staticmethod
    def update(schema_name: str, table_name: str, data_json, id_column_name: str):
        """
    ...
    @staticmethod
    def delete(schema_name: str, table_name: str, data_json, id_column_name: str):
        """
