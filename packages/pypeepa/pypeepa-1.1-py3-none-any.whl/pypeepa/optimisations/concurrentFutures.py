...
def concurrentFutures(
    ...
    `thread_executor`: (Optional) If True then ThreadPoolExcecutor will be used.\n
    `max_workers`: (Optional) The maximum number of parallel processes/threads.\n
    `logger`: (Optional) You can pass a logging object if you already initialized one.\n
    """
    start = time.time()
