# source: https://github.com/SciML/diffeqpy/blob/master/diffeqpy/setup.jl
...
@debug "Importing Knockoffsjl...."
try
    import Knockoffs
catch err
    @error "Failed to import Knockoffs.jl" exception = (err, catch_backtrace())
    rethrow()
end