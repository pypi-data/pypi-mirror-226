...
def load_input_transform_function(model_file):
...
def load_export_transform_function(model_file):
    ...
    module_name = "export_transform_function" #The file name will always be custom_architecture because this is how ketos saves it
    module_path = zipimport.zipimporter(path / "custom") # the folder name within the zip archive will always be custom
    spec = module_path.find_spec(module_name)
