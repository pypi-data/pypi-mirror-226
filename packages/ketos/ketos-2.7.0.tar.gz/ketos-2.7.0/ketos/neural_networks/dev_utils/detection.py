...
def batch_load_hdf5_data(hdf5_file_path, batch_size, audio_representation, table_name=None, logger=None):
    """
    ...
    with tables.open_file(hdf5_file_path, 'r') as hdf5_file:
        ...
        for i in trange(num_batches):
            try:
                ...
                batch_data['data'] = hdf5_batch_data['data']
                batch_data['filename'] = hdf5_batch_data['filename']
...
def batch_load_audio_file_data(loader, batch_size, logger=None):
    """
