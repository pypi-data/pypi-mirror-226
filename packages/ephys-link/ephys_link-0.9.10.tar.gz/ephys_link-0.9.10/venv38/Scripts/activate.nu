...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Documents\School GitHub\VBL\ephys-link\venv38'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Documents\School GitHub\VBL\ephys-link\venv38\Scripts\deactivate.nu'
