...
'''
 ...
 LastEditTime : 2023-08-22 09:57:17
...
def calculate_flops(model,
    ...
    if output_as_string:
        return flops_to_string(flops, precision=output_precision),\
               macs_to_string(macs, precision=output_precision), \
               params_to_string(params, precision=output_precision)
