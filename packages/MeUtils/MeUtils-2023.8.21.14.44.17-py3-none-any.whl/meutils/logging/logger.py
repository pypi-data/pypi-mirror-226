...
class LoggerSettings(BaseModel):
    sink: Any = os.getenv("LOG_SINK", sys.stdout)  # todo: 邮件 飞书等等
    level: str = logging.getLevelName(os.getenv("settings.level", "DEBUG"))
...
def init_logger() -> None:
    ...
    handlers = [{"sink": settings.sink, "level": settings.level, "serialize": settings.serialize, "enqueue": True}]
