...
class LoggerSettings(BaseModel):
    ...
    sink_stdout: bool = True if os.getenv("LOG_SINK_STDOUT", '1') != '0' else False

    level: str = logging.getLevelName(os.getenv("LOG_LEVEL", "DEBUG"))
    serialize: bool = True if os.getenv("LOG_SERIALIZE", '1') != '0' else False
...
def init_logger() -> None:
    ...
    handlers = [{"sink": sys.stdout}] if settings.sink_stdout else []
    handlers += [
        {
            "sink": settings.sink or sys.stdout,
