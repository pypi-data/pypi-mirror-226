...
def initialize_iokit_functions_and_variables():
    ...
    After calling this function, the following IOKit functions are available:
        ...
        IOServiceMatching
            Returns a dictionary that specifies an IOService clast match.
        IOIteratorNext
...
clast DisplayMode(object):
    """
    This clast describes a display mode, at least as I like to look at them.
    ...
    def __eq__(self, other):
        return (
            isinstance(other, self.__clast__)   and
...
def get_all_current_configurations():
    """
    Gets a list of all displays and their astociated current display modes.
...
def sub_set(command, width, height, depth, refresh, display=None, hidpi=1):
    ...
    :param command: The command pasted in.
