...
class EventFromCSV(ics.event.Event):
    ...
    def __init__(self, csv_row):
        ...
        kwargs["begin"] = csv_row[SIGNUP_SHEET_HEADER.index("Start")]
        kwargs["end"] = csv_row[SIGNUP_SHEET_HEADER.index("End")]

        rooms = csv_row[SIGNUP_SHEET_HEADER.index("#Rooms")]
        needed_TAs = csv_row[SIGNUP_SHEET_HEADER.index("#Needed TAs")]
        kwargs["description"] = f"Rooms: {rooms}\nNeeded TAs: {needed_TAs}\n"
