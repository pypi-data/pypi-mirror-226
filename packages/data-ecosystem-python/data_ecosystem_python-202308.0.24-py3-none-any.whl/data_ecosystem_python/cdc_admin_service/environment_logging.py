...
if OS_NAME.lower() == "nt":
    ...
    LOG_FILENAME = ENV_SHARE_PATH + "\\data_ecosystem_pythonogging.txt"
else:
    ...
    desired_log_filename = "data_ecosystem_pythonogging.txt"
...
try:
    ...
    if not FOLDER_EXISTS:
        if platform.system() != 'Windows':
            ...
            LOG_FILENAME = ENV_SHARE_FALLBACK_PATH + "/data_ecosystem_pythonogging.txt"
