...
This module also imports the following class objects from the 'data_ecosystem_python.cdc_admin_service' module:
...
- The 'Table' class from the 'data_ecosystem_python.alation_service.table' module is used for representing tables in the 'ManifestJson' class.
"""
    ...
    def set_alation_data(self, manifest_json):
        ...
        with tracer.start_as_current_span("set_alation_data"):
            ...
            try:
                ...
                from data_ecosystem_python.alation_service.db_table import Table
