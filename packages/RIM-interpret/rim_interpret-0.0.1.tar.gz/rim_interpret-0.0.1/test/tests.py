...
import sys
sys.path.append("..")
from src.inter_metrics import get_pfi, get_shap, get_lime, get_inter
...
lime_df_en = get_lime(fit=fit_en, X_train=X_train, X_test=X_test, task="regression")
inter_df_en = get_inter(fit=fit_en, X_train=X_train, X_test=X_test, y_test=y_test, task="regression", model_type="Linear")
...
lime_df_rf = get_lime(fit=fit_rf, X_train=X_train, X_test=X_test, task="regression")
inter_df_rf = get_inter(fit=fit_rf, X_train=X_train, X_test=X_test, y_test=y_test, task="regression", model_type="Tree")
