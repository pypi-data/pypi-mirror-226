...
class CreatePasswordPage(BasePage):
    ...
    def insert_password(self):
        ...
        insert password
        """
        self.enter_text_on_specific_list_item("PASSWORD_INPUT", PASSWORD_INPUT, 0, pytest.wallets_data.get("password"))

    def insert_confirm_password(self):
        """
        insert confirm password
        """
        self.enter_text_on_specific_list_item("CONFIRM_PASSWORD_INPUT", PASSWORD_INPUT, 1, pytest.wallets_data.get("password"))
