...
from pyenopt.enums import ConstraintType, OptimizationEventType
from pyenopt.results import FunctionResults, GradientResults
from .database import Database
from .snapshot import PyenoptSnapshot
...
class SqliteStorage:
    ...
    def get_optimal_result(self):
        snapshot = PyenoptSnapshot(self._output_dir)
        optimum = next(
            (
                data
