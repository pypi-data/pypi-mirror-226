...
class Database:
    ...
    def load_experiment(self, experiment_id=None, retries=5):
        ...
        # :return experiment
        # :rtype pyenopt.database.Experiment
        error_msg = None
    ...
    def add_control_definition(self, name, init_value, min_value, max_value):
        ...
        # :return controlDef
        # :rtype pyenopt.database.ControlDefinition
    ...
    def load_realization(self, name=None, realization_id=None):
        ...
        # :type name: str
        # :return realization
        # :rtype pyenopt.database.Realization
    ...
    def add_function(
        ...
        # :return function
        # :rtype pyenopt.database.Function
    ...
    def load_simulation(self, name=None, simulation_id=None):
        ...
        # :return: pyenopt.database.Simulation
        conn = self._get_connection()
    ...
    def add_gradient_result(
        ...
        # :rtype pyenopt.database.GradientResult
