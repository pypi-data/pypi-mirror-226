...
T = TypeVar("T", bound="HamiltonNodeDependencies")


@attr.s(auto_attribs=True)
class HamiltonNodeDependencies:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        hamilton_node_dependencies = cls()
        ...
        hamilton_node_dependencies.additional_properties = additional_properties
        return hamilton_node_dependencies
