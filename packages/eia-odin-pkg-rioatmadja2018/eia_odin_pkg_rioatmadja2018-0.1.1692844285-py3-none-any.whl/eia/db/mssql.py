...
class OdinDBMSSQL(object): 
    ...
    def get_store_reivews(self, lat: float, lon: float):
        ...
        try: 
            ...
            return query_result.drop_duplicates(['gas_station_name', 'address', 'review_date', 'profile_image', 'review', 'latitude', 'longitude' ]) if query_result.shape[0] > 0 else query_result
