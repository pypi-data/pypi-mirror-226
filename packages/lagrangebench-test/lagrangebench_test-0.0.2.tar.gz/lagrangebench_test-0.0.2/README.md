...
## Installation (Pip)
If you only want to install the core `lagrangebench_test` library, use the Pip wheel.
```bash
pip install lagrangebench_test
```

## Installation (Clone)
1. Clone the GitHub repository
    ```bash
    git clone https://github.com/tumaer/lagrangebench_test.git
    cd lagrangebench_test
    ```
