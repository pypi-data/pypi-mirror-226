...
def data(train_set=[], train_labels=[], test_set=[], test_labels=[], val_set=[], val_labels=[], dataset_name="", #checks if data is same as prev
  ...
  if os.path.exists(newest_data_folder + '/train_labels.pkl'):
  ...
  if (os.path.exists(newest_data_folder + '/val_labels.pkl')) and (save_new_data_flag == 0):
      if len(val_labels) > 0:
  ...
  if (os.path.exists(newest_data_folder + '/test_labels.pkl')) and (save_new_data_flag == 0):
  ...
  if save_new_data_flag == 1:
      ...
      if len(test_labels) > 0:
        ...
        if len(val_set) > 0:
            config_dict.update({'train_set': newest_data_folder + '/val_set.pkl'})
        if len(test_set) > 0:
            config_dict.update({'train_set': newest_data_folder + '/test_set.pkl'})
        if len(train_labels) > 0:
            config_dict.update({'train_set': newest_data_folder + '/train_labels.pkl'})
        if len(val_labels) > 0:
            config_dict.update({'train_set': newest_data_folder + '/val_labels.pkl'})
        if len(test_labels) > 0:
            config_dict.update({'train_set': newest_data_folder + '/test_labels.pkl'})
