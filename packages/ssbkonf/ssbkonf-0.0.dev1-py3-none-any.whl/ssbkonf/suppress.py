...
_gs = importr_tryhard("GaussSuppression")
...
def suppress_small_counts(
    ...
    (
        ...
        formula=formula,
        # protect_zeros=protect_zeros,
        # secondary_zeros=secondary_zeros,
    )
    out = _gs.SuppressSmallCounts(
        data=rdata,
        maxN=max_n,
        freqVar=freq_var,
        dimVar=dim_var,
...
def suppress_few_contributors(
    ...
    out = _gs.SuppressFewContributors(
        data=rdata,
        maxN=max_n,
        freqVar=freq_var,
        numVar=num_var,
