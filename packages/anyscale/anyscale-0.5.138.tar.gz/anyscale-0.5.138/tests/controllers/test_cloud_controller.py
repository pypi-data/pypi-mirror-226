...
@pytest.mark.parametrize(
    ("has_cloud_resource", "cloud_provider", "edit_succeed",),
    [
        pytest.param(True, "AWS", True),
        pytest.param(True, "GCP", True),
        pytest.param(False, "AWS", True),
        pytest.param(True, "AWS", False),
    ],
)
def test_edit_cloud(has_cloud_resource: bool, cloud_provider: str, edit_succeed: bool):
    mock_cloud = Mock(result=Mock(provider=cloud_provider,))
