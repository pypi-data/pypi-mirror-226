...
def main():  
    ...
    blastdb = nf_path + "/../blast_db/human_db"
    ...
    if Job == 1:
        ...
        mlres = mlres.round(3)
        if hst == 1:    
            os.system(blastp + " -task blastp-short -db " + blastdb + "/human_db -query " + filename  + " -out RES_1_6_6.out -outfmt 6 -evalue 0.001")
        else:
            os.system(blastp + " -task blastp-short -db " + blastdb + "/mouse_db -query " + filename  + " -out RES_1_6_6.out -outfmt 6 -evalue 0.001")
