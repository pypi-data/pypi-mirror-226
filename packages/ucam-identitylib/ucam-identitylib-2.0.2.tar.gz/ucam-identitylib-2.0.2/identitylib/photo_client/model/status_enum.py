...
class StatusEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): * `APPROVED` - APPROVED * `UNAPPROVED` - UNAPPROVED * `INVALIDATED` - INVALIDATED., must be one of ["APPROVED", "UNAPPROVED", "INVALIDATED", ]  # noqa: E501

        Keyword Args:
            value (str): * `APPROVED` - APPROVED * `UNAPPROVED` - UNAPPROVED * `INVALIDATED` - INVALIDATED., must be one of ["APPROVED", "UNAPPROVED", "INVALIDATED", ]  # noqa: E501
