...
def lazy_import():
    ...
    globals()['ActionEnum'] = ActionEnum


class PhotoIdentifierBulkUpdateUpdateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action, id, *args, **kwargs):  # noqa: E501
        """PhotoIdentifierBulkUpdateUpdateRequest - a model defined in OpenAPI
