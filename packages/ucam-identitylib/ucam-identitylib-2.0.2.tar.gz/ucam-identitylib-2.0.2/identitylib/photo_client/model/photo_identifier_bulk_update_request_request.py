...
def lazy_import():
    ...
    globals()['PhotoIdentifierBulkUpdateUpdateRequest'] = PhotoIdentifierBulkUpdateUpdateRequest


class PhotoIdentifierBulkUpdateRequestRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'updates': ([PhotoIdentifierBulkUpdateUpdateRequest],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, updates, *args, **kwargs):  # noqa: E501
        """PhotoIdentifierBulkUpdateRequestRequest - a model defined in OpenAPI

        Args:
            updates ([PhotoIdentifierBulkUpdateUpdateRequest]):
