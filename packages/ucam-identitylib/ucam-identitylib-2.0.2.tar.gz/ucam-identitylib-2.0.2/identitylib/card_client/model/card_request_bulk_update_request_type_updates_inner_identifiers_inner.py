...
class CardRequestBulkUpdateRequestTypeUpdatesInnerIdentifiersInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CardRequestBulkUpdateRequestTypeUpdatesInnerIdentifiersInner - a model defined in OpenAPI
