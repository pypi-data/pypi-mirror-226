...
def lazy_import():
    ...
    globals()['CardIdentifierAllowedActions'] = CardIdentifierAllowedActions
...
class CardIdentifier(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'value': (str,),  # noqa: E501
            'allowed_actions': (CardIdentifierAllowedActions,),  # noqa: E501
    ...
    def _from_openapi_data(cls, card_requests, cards, related_identifiers, scheme, value, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            allowed_actions (CardIdentifierAllowedActions): [optional]  # noqa: E501
