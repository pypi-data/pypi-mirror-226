...
class Student(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'forenames': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'identifiers': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'name_prefixes': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'surname': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'date_of_birth': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, affiliations, forenames, identifiers, name_prefixes, surname, *args, **kwargs):  # noqa: E501
        ...
        Args:
            affiliations (bool, date, datetime, dict, float, int, list, str, none_type): The list of entities that this student is affiliated with. Currently this includes college and department affiliations (under the scheme `institution.v1.student-records.university.identifiers.cam.ac.uk`) and any active academic plan (under the scheme `institution.v1.student-records.university.identifiers.cam.ac.uk`).
            forenames (bool, date, datetime, dict, float, int, list, str, none_type): The forenames of this student, split by a single space.
            identifiers (bool, date, datetime, dict, float, int, list, str, none_type): The identifiers attached to this student record. Currently only identifiers of the scheme person.v1.student-records.university.identifiers.cam.ac.uk (USN) are included, but additional identifier types may be added in future.
            name_prefixes (bool, date, datetime, dict, float, int, list, str, none_type): The name prefixes of this student, split by a single space.
            surname (bool, date, datetime, dict, float, int, list, str, none_type): The surname of this student.
        ...
        Keyword Args:
            ...
            date_of_birth (bool, date, datetime, dict, float, int, list, str, none_type): The date of birth of this student. There are a minority of cases where this is not known.. [optional]  # noqa: E501
        """
