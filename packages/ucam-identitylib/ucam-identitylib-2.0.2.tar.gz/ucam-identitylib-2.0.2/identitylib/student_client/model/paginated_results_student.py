...
class PaginatedResultsStudent(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'previous': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        ...
        Args:
            results (bool, date, datetime, dict, float, int, list, str, none_type): A list of the current page of results.
        ...
        Keyword Args:
            ...
            next (bool, date, datetime, dict, float, int, list, str, none_type): The url to use to retrieve the next page of results.. [optional]  # noqa: E501
            previous (bool, date, datetime, dict, float, int, list, str, none_type): The url to use to retrieve the previous page of results.. [optional]  # noqa: E501
        """
