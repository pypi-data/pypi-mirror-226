...
class Affiliation(ModelNormal):
    ...
    def _from_openapi_data(cls, scheme, status, value, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            status (bool, date, datetime, dict, float, int, list, str, none_type): A student's status within an affiliated entity. Currently this will be any of the Academic Careers documented within the [CamSIS Coding Manual](https://www.camsis.cam.ac.uk/technical/camsis-coding-manual).
            value (bool, date, datetime, dict, float, int, list, str, none_type): The value of this affiliation. This will be specific to the student management system, indicating an entity that this student is affiliated with.
        ...
        Keyword Args:
            ...
            end (bool, date, datetime, dict, float, int, list, str, none_type): The end date of this affiliation. May not be populated if not known.. [optional]  # noqa: E501
            start (bool, date, datetime, dict, float, int, list, str, none_type): The start date of this affiliation. May not be populated if not known.. [optional]  # noqa: E501
        """
