...
class StaffMembersApi(object):
    ...
    def list_v1alpha2_staff_staff_get(
        ...
        **kwargs
        ...
        Keyword Args:
            affiliation (bool, date, datetime, dict, float, int, list, str, none_type): An affiliation to filter by, in the format `<value>@<scheme>`. When included only the staff members with a matching affiliation are returned.. [optional]
            ...
            page_size (bool, date, datetime, dict, float, int, list, str, none_type): The number of results to return per page. This is limited to 999 results, if a number over 999 is provided the results will be capped at 999. Defaults to 200.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
