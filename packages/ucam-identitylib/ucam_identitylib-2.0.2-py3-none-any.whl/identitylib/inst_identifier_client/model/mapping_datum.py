...
class MappingDatum(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, identifiers, instid, *args, **kwargs):  # noqa: E501
        """MappingDatum - a model defined in OpenAPI

        Args:
            identifiers ([str]): List of identifiers of this institution in various databases. Each identifier is of the form `{identifier}@{namespace}`.
            instid (str): Lookup instid for this institution.
    ...
    @convert_js_args_to_python_args
    def __init__(self, identifiers, instid, *args, **kwargs):  # noqa: E501
        """MappingDatum - a model defined in OpenAPI
