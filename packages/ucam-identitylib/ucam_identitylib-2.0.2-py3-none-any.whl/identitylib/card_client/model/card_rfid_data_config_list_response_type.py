...
def lazy_import():
    ...
    globals()['CardRFIDDataConfigListResponseTypeResultsInner'] = CardRFIDDataConfigListResponseTypeResultsInner


class CardRFIDDataConfigListResponseType(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([CardRFIDDataConfigListResponseTypeResultsInner],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """CardRFIDDataConfigListResponseType - a model defined in OpenAPI

        Args:
            results ([CardRFIDDataConfigListResponseTypeResultsInner]):
