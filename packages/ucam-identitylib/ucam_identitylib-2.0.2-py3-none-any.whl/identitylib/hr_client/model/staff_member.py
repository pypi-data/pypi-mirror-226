...
class StaffMember(ModelNormal):
    ...
    def _from_openapi_data(cls, affiliations, forenames, identifiers, name_prefixes, surname, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            forenames (bool, date, datetime, dict, float, int, list, str, none_type): The forenames of this member of staff, split by a single space.
            identifiers (bool, date, datetime, dict, float, int, list, str, none_type): The identifiers attached to this staff record.
            name_prefixes (bool, date, datetime, dict, float, int, list, str, none_type): The name prefixes of this member of staff, split by a single space.
            surname (bool, date, datetime, dict, float, int, list, str, none_type): The surname of this member of staff.
        ...
        Keyword Args:
            ...
            date_of_birth (bool, date, datetime, dict, float, int, list, str, none_type): The date of birth of this member of staff. [optional]  # noqa: E501
        """
