...
class Affiliation(ModelNormal):
    ...
    def _from_openapi_data(cls, scheme, status, value, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            status (bool, date, datetime, dict, float, int, list, str, none_type): A staff member's status in relation to an affiliated entity. Currently this will be their job title or `report`, indicating that this person reports to the affiliated entity.
            value (bool, date, datetime, dict, float, int, list, str, none_type): The value of this affiliation. This will be specific to the human resources system, indicating an entity that this staff member is affiliated with.
        ...
        Keyword Args:
            ...
            end (bool, date, datetime, dict, float, int, list, str, none_type): The end date of this affiliation. May not be populated if the affiliation is open-ended.. [optional]  # noqa: E501
