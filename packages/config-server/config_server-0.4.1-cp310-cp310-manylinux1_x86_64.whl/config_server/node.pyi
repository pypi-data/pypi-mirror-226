...
from config_server.utils import ValidationResult as ValidationResult, convert_text_to_comment as convert_text_to_comment, get_blank_repr_for_field as get_blank_repr_for_field, remove_intent_of_text as remove_intent_of_text
...
class ConfigNodeMeta(Incomplete, type):
    def __new__(cls, *args, **kwargs): ...

class ConfigNode(BaseModel, metaclass=ConfigNodeMeta):
    __doc__: str
    @classmethod
