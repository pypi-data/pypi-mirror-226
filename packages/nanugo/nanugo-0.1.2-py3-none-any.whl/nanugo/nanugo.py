...
class Builder:
    ...
    def build_pkg(self, builder_decks: list) -> genanki.Package:
        ...
        logger.info(f"Total {len(decks)} deck(s) and {len(media_list)} media file(s) will be added to the package.")
    ...
    def __del__(self):
        if os.path.exists(self.tempdir):
            ...
            logger.debug(f"tempdir {self.tempdir} was removed and the Builder object will be deleted.")