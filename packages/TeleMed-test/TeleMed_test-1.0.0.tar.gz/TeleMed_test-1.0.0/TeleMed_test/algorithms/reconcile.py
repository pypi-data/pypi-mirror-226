...
class ReconcileClass():
    ...
    def reconcile_experiment(self) -> Tuple[pd.DataFrame, pd.Series, pd.DataFrame,pd.DataFrame, 
        ...
        return test_rec_pred, metrics, scores, valid_rec_pred, model_to_log, exec_time_info
