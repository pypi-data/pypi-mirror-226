    ...
    class ProvisioningArtifactPropertiesProperty:
        def __init__(
            ...
            *,
            ...
            :param type: The type of provisioning artifact. - ``CLOUD_FORMATION_TEMPLATE`` - AWS CloudFormation template - ``TERRAFORM_OPEN_SOURCE`` - Terraform open source configuration file
