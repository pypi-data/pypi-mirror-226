...
class CfnLiveSource(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param http_package_configurations: 
        :param live_source_name: 
        :param source_location_name: 
    ...
    class HttpPackageConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param path:  This is combined with SourceLocation::HttpConfiguration::BaseUrl to form a valid URL.
            :param source_group:  This has to match one of the Channel::Outputs::SourceGroup.
            :param type: 
