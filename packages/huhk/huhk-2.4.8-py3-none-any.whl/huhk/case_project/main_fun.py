...
if __name__ == '__main__':
    ...
    running_testcase(["yhzx/web/drop"], case_path=r"D:\projects\python_test\ardar_test\autotest\codes\1\testcase",
                     report_path=r"D:\projects\python_test\huhk-common\report\test6")