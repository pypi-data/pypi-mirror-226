...
class _Provider:
    ...
    def _init(self, rep: str, load: typing.Union[typing.Callable[[modal._resolver.Resolver, typing.Union[str, None], _Handle], typing.Awaitable[None]], None] = None, is_persisted_ref: bool = False, preload: typing.Union[typing.Callable[[modal._resolver.Resolver, typing.Union[str, None], _Handle], typing.Awaitable[None]], None] = None):
        ...
...
class Provider:
    ...
    class ___init_spec(typing_extensions.Protocol):
        def __call__(self, rep: str, load: typing.Union[typing.Callable[[modal._resolver.Resolver, typing.Union[str, None], Handle], None], None] = None, is_persisted_ref: bool = False, preload: typing.Union[typing.Callable[[modal._resolver.Resolver, typing.Union[str, None], Handle], None], None] = None):
            ...

        def aio(self, rep: str, load: typing.Union[typing.Callable[[modal._resolver.Resolver, typing.Union[str, None], Handle], typing.Awaitable[None]], None] = None, is_persisted_ref: bool = False, preload: typing.Union[typing.Callable[[modal._resolver.Resolver, typing.Union[str, None], Handle], typing.Awaitable[None]], None] = None):
            ...
