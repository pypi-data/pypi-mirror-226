...
parser.add_argument('--surnames', default=False, action="store_true")
...
if (args.surnames):
    for i in csvlist:
        surname = str(i[0].upper())
        surname = du.white_space_inside_by(surname, "_")
        surname = re.sub(r'\-', r'_', name)
        surname = re.sub(r'\/', r'', name)
