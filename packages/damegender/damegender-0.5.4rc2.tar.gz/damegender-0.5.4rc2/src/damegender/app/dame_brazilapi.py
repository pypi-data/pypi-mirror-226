...
class DameBrazilApi(Gender):
    ...
    def get(self, name):
        ...
        v = {}
        v['name'] = name
        string = 'https://servicodados.ibge.gov.br/api/v2/censos/nomes/'
        string = string + name + "?sexo=F"
        ...
        try:
            ...
            count = 0
        v['females'] = count
        string2 = 'https://servicodados.ibge.gov.br/api/v2/censos/nomes/'
        string2 = string2 + name + "?sexo=M"
    ...
    def download_csv(self, path="files/names/partial.csv", *args, **kwargs):
        ...
        for i in names:
            ...
            if (freq > 0):
                ...
                str0 = i+","+str(freq)+","+str(per_males)
                str0 = str0+","+str(per_females)+"\n"
                file_all.write(str0)
        file_all.close()
        file_females.close()
        file_males.close()
