...
class MainController():
    ...
    def graphics_selection_changed(self):
        selected_items = self.graphics().scene().selectedItems()       
        if len(selected_items) == 1:
            self.select_item(selected_items[0])
...
if __name__ == "__main__":  
    ...
    project = '../../example_projects/Stabin/F18.zip'
