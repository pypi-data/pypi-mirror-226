...
@_dispatch.add_type_based_api_dispatcher
@tf_export('fftnd')
def fftnd(input: _atypes.TensorFuzzingAnnotation[TV_FFTND_Tcomplex], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[TV_FFTND_Tcomplex]:
...
def fftnd_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_FFTND_Tcomplex], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_FFTND_Tcomplex]:
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('ifftnd')
def ifftnd(input: _atypes.TensorFuzzingAnnotation[TV_IFFTND_Tcomplex], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[TV_IFFTND_Tcomplex]:
...
def ifftnd_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_IFFTND_Tcomplex], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_IFFTND_Tcomplex]:
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
  fft_length = _ops.convert_to_tensor(fft_length, _dtypes.int32)
  axes = _ops.convert_to_tensor(axes, _dtypes.int32)
  _inputs_flat = [input, fft_length, axes]
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('irfftnd')
def irfftnd(input: _atypes.TensorFuzzingAnnotation[TV_IRFFTND_Tcomplex], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Treal:TV_IRFFTND_Treal=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_IRFFTND_Treal]:
...
def irfftnd_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_IRFFTND_Tcomplex], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Treal: TV_IRFFTND_Treal, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_IRFFTND_Treal]:
  if Treal is None:
    Treal = _dtypes.float32
  Treal = _execute.make_type(Treal, "Treal")
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('rfftnd')
def rfftnd(input: _atypes.TensorFuzzingAnnotation[TV_RFFTND_Treal], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tcomplex:TV_RFFTND_Tcomplex=_dtypes.complex64, name=None) -> _atypes.TensorFuzzingAnnotation[TV_RFFTND_Tcomplex]:
...
def rfftnd_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_RFFTND_Treal], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tcomplex: TV_RFFTND_Tcomplex, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RFFTND_Tcomplex]:
  if Tcomplex is None:
    Tcomplex = _dtypes.complex64
  Tcomplex = _execute.make_type(Tcomplex, "Tcomplex")
  _attr_Treal, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float32, _dtypes.float64, ], _dtypes.float32)
