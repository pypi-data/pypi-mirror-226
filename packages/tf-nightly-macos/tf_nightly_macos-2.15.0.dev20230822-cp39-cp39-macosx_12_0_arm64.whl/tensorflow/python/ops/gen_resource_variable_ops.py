...
def var_handle_op(dtype: TV_VarHandleOp_dtype, shape, container:str="", shared_name:str="", debug_name:str="", allowed_devices=[], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
...
def var_handle_op_eager_fallback(dtype: TV_VarHandleOp_dtype, shape, container: str, shared_name: str, debug_name: str, allowed_devices, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  dtype = _execute.make_type(dtype, "dtype")
  shape = _execute.make_shape(shape, "shape")
  if container is None:
    container = ""
