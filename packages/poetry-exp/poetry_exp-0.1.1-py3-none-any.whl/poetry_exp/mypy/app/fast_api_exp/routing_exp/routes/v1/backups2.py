from fastapi import APIRouter, responses, Request, Header, Depends
...
async def create_backup(request_obj: Request, request_body: backups.BackupPostRequest, authorization: HTTPAuthorizationCredentials=Depends(auth_scheme) ):
    try:
