...
SOME_MEASURE = Histogram(
    'atlas_vmware_hypervisor_managers_per_customer_total6',
    'Number of registered vmware hypervisor managers',
    buckets=buckets, labelnames=("hypervisor_manager",))


def log_vc_counts():
    print('Clearing the matrics')
    try:
       # Clear the previous one
       SOME_MEASURE.remove("vmware")
    ...
    for vc in vc_counts:
        ...
        SOME_MEASURE.labels(hypervisor_manager="vmware").observe(count)
