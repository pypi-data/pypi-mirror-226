...
volume_length = 1099511627776  # Bytes  (1 TB)    # working Creates 2 MB bitmap file
#volume_length = 1125899906842624  # Bytes  (1 PB) # Not working MemoryError
...
def write_bits(bits_str):
    ...
    with open("sample_bitmap.bin", 'bw') as f:
        f.write(buffer)
...
def convert_map():
    ...
    map = [str(0) for i in range(total_blocks)]
    #print(f'map: {map}')
