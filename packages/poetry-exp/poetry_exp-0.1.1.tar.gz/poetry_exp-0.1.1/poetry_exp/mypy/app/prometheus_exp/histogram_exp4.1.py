...
# https://calculationcalculator.com/1e+9-to-number
buckets = (
    1000000000,  # (1 GB)   # 1e+9
    2000000000,  # (2 GB)   # 2e+9
    5000000000,  # (5 GB)
    10000000000,  # (10 GB)
    20000000000,  # (20 GB)
    50000000000,  # (50 GB)
...
if __name__ == '__main__':
    ...
    backup_sizes = range(int((1000000000/1024.0)/1024.0), int((1000000000000000/1024.0)/1024.0))
    d = dict()
    i = 0
    while True:
        ...
        if b in d:
            ...
            d[b] = 1
        print(d)
        SOME_MEASURE.labels(app_type="vmware", assets_category="vmfs_vms").observe(b*1024*1024)
        time.sleep(.2)
        if i == 500:
            print('sleeping....')
            time.sleep(20 * 60 * 60)
