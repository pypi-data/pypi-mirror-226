...
def main(ds_name, remote_file_path, local_file_path):
...
if __name__ == "__main__":
    datastore = "1_Production"
    remote_file_path_ = "WIN_TEST_VM/WIN_TEST_VM-5.png"
    local_file_path = "C:\\Users\\aafakmoh\\OneDrive - Hewlett Packard Enterprise\\mypy\\vmware_exp\\examples\\capture_screenshot.png"
    main(datastore, remote_file_path_, local_file_path)
