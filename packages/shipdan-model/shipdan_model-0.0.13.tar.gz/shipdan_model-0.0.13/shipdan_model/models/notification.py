...
class SMSNotificationMessage(models.Model):
    ...
    class Meta:
        db_table = 'notification_snsnotificationmessage'
...
class SMSNotification(models.Model):
    ...
    class Meta:
        db_table = 'notification_snsnotification'
...
class CouponAutomaticPage(models.Model):
    ...
    class Meta:
        db_table = 'notification_customautomaticpage'
...
class AmazonSNSPlatformApplication(models.Model):
    ...
    class Meta:
        db_table = 'notification_amazonsnsplatformapplication'
