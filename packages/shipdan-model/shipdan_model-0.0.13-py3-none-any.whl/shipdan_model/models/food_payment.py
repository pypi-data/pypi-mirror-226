...
class CouponDiscount(models.Model):
    ...
    class Meta:
        db_table = 'food_payment_counpondiscount'
...
class CouponDiscountTarget(models.Model):
    ...
    class Meta:
        db_table = 'food_payment_counpondiscounttarget'
...
class FoodOrderCouponTemporaryRelation(models.Model):
    ...
    class Meta:
        db_table = 'food_payment_foodordercouponteporaryrelation'
