...
from shipdan_model.models.food import FoodGroup, Unit
...
class FoodProductChangeRequestContent(models.Model):
    ...
    brand = models.ForeignKey('food.FoodBrand', null=True, blank=True, on_delete=models.SET_NULL)
    group = models.ForeignKey('food.FoodGroup', blank=True, to_field='code', default=FoodGroup.UNDEFINED,
                              on_delete=models.SET_DEFAULT)
    platform = models.ForeignKey('food.FoodProductOrigin', on_delete=models.CASCADE, null=True, blank=True)
    third_category = models.ForeignKey('food.ThirdCategory', null=True, blank=True, on_delete=models.CASCADE)
    ...
    # foreign key
    except_days = models.ManyToManyField('food.ProductExceptDay', )
    allergies = models.ManyToManyField('health.Allergy', )
    sub_search_categories = models.ManyToManyField('food.FoodSubSearchCategory', )
    sub_classifications = models.ManyToManyField('food.FoodSubClassification', )
...
class FoodPurchaseOrderSheet(models.Model):
    ...
    company = models.ForeignKey('food.FoodCompany', on_delete=models.CASCADE, related_name='purchase_order_sheets', null=True)
    started_at = models.DateTimeField(null=True)
    ended_at = models.DateTimeField(null=True)
