...
class ModelsApi(object):
    ...
    @validate_arguments
    def get_model(self, id : constr(strict=True, min_length=1), x_gradient_workspace_id : constr(strict=True, min_length=1), **kwargs) -> GetModelSuccess:  # noqa: E501
    ...
    @validate_arguments
    def get_model_with_http_info(self, id : constr(strict=True, min_length=1), x_gradient_workspace_id : constr(strict=True, min_length=1), **kwargs) -> ApiResponse:  # noqa: E501
        """Describe model  # noqa: E501
    ...
    @validate_arguments
    def train_model(self, id : constr(strict=True, min_length=1), x_gradient_workspace_id : constr(strict=True, min_length=1), train_model_request_body : TrainModelRequestBody, **kwargs) -> TrainModelSuccess:  # noqa: E501
        ...
        >>> thread = api.train_model(id, x_gradient_workspace_id, train_model_request_body, async_req=True)
        >>> result = thread.get()
        ...
        return self.train_model_with_http_info(id, x_gradient_workspace_id, train_model_request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def train_model_with_http_info(self, id : constr(strict=True, min_length=1), x_gradient_workspace_id : constr(strict=True, min_length=1), train_model_request_body : TrainModelRequestBody, **kwargs) -> ApiResponse:  # noqa: E501
        """Train model  # noqa: E501
        ...
        >>> thread = api.train_model_with_http_info(id, x_gradient_workspace_id, train_model_request_body, async_req=True)
        >>> result = thread.get()
