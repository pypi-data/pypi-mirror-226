...
class Location(GenericCRUD):
    ...
    def read_location(self, location_id: int) -> tuple([any, str, str, str, str, str, str, str, str, str]):
        READ_LOCATION_METHOD_NAME = 'read_location'
        logger.start(READ_LOCATION_METHOD_NAME)

        query_get = '''SELECT l.coordinate, l.address_local_language, l.address_english, n.title, r.title, 
                            c.title, s.state_name, co.name,l.postal_code, l.plus_code 
        ...
        if result is None:
            ...
            return None
        # Couldn't unpack coordinate to latitude and longitude
        (coordinate, address_local_language, address_english, neighborhood,
