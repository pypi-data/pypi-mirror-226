...
# --------------------------------------------------------------------
def output_nested_lists(nested_lists: list, header, title: list, get_info_str: bool, line_prefix = ""):
...
# =======================================================================================================================
def print_dict_as_table(key, dict_list, info_struct, attr_names, get_info_str, line_prefix, title):
    '''
    key - the policy type
    ...
    reply_data = output_nested_lists(print_list, title, attr_names, get_info_str, line_prefix)
