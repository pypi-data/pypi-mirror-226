...
def email_send(status, io_buff_in, cmd_words, trace):
    ...
    message = "AnyLog Network Alert from Node: %s" % params.get_node_name() # default message
...
def sms_send(status, io_buff_in, cmd_words, trace):
    ...
    message = interpreter.get_one_value_or_default(conditions, "message","AnyLog Network Alert from Node: '%s'" % params.get_node_name())
