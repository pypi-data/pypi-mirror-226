...
def monitor_info(status, io_buff_in, cmd_words, trace):
    ...
    if not ret_val:
        ...
        json_info = interpreter.get_one_value(conditions, "info")
        ...
        if not ret_val:
            ...
            if node_id not in network_status_[topic]:
                info_dict = {}
...
def get_info(status, io_buff_in, cmd_words, trace):
    ...
    return [process_status.SUCCESS, info_str, "json"]
