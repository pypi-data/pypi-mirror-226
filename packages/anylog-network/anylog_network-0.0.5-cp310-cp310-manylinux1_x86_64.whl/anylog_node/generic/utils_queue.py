...
class MsgQueue():
    ...
    def update_prompt(self, data_in_buff):
        if params.queue_msg != data_in_buff:
            # Prompt state is different
            params.queue_msg = False  # Flag no messages in the queue
    ...
    def add_msg(self, message):
        ...
        if first_message:
            params.queue_msg = True  # Flag new messages in the queue
            utils_print.output("Messages in Echo Queue! ...", True)
        elif not params.queue_msg:
    ...
    def get_mssages(self):
        ...
        params.queue_msg = False  # Flag no new messages in the queue
        self.queue_mutex.release()
