...
class OutputManager():
    ...
    # =======================================================================================================================
    def finalize(self, status, io_buff_in, rows_counter, dbms_time, is_mutex, is_query_end):
        '''
        ...
        if self.destination == "buffer":
            ...
            if not ret_val:
                if self.add_stat:
                    ...
                    ret_val = self.out_statistics(status, rows_counter, dbms_time, False, prefix_str, "", True)
                else:
            ...
            if not rows_counter:
                ...
                if self.add_stat:
                    ...
                    ret_val = self.out_statistics(status, rows_counter, dbms_time, False, prefix_str, "", double_lines_stat)
                else:
                    # complete last row
    ...
    # =======================================================================================================================
    def out_statistics(self, status, rows_counter, dbms_time, is_prompt, prefix_str, suffix_str, is_2lines):
        ...
        if not self.test:
            ...
            info_str = "%s\"Statistics\":[{\"Count\": %u,%s\"Time\":\"%02u:%02u:%02u\",%s\"Nodes\": %u}]}%s" % (
                prefix_str, rows_counter, mid_str, hours_time, minutes_time, seconds_time, mid_str, self.nodes_count, suffix_str)
