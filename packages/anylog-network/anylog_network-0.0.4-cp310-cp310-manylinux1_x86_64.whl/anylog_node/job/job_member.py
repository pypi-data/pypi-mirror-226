...
from anylog_node.blockchain.al_auth import decrypt_node_message, generate_fernet, symetric_decryption
...
class JobMember:
    ...
    def set_decryption_passwords(self, status, encryption_key):
        ...
        password_text = decrypt_node_message(status, encryption_key)
        if password_text:
            ...
            self.f_object = generate_fernet(status, self.password, self.salt.encode())
        else:
    ...
    def decrypt_data(self, status, data):
        return symetric_decryption(status, self.f_object, data)
    # =======================================================================================================================
    # Return the length of the encryption key.
    # =======================================================================================================================
