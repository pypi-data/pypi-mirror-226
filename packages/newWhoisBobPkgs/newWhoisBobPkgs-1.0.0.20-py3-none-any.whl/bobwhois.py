...
whitelist_country = ''
botEmail_origin = "bob8gook_whois@webex.bot"
botEmail_messi = "bob8gookmessi@webex.bot"
accessToken_origin = "MGY3ZWI0N2ItZjI0ZC00MzQ2LWFlNjYtNDc0MWM3NDNlNGQ2ODI1MzQ4MzAtZmMz_PF84_22cb7792-d880-4ec5-b6a6-649d9411bb5e"
accessToken_messi = 'NTQ2NWU1OGQtZmU1OC00YzM2LWJiMTUtNzdjY2ZmZjA1MzA0ZWI4N2U1MTUtZGE2_PF84_22cb7792-d880-4ec5-b6a6-649d9411bb5e'

accessToken = accessToken_origin
botEmail = botEmail_origin
...
def SendMessage(payload, msg, roomId=''):
    roomId_origin = payload["roomId"]
    if roomId != '':
...
def get_tasks():
    ...
    if AuthenticateUser(email) == False:
        SendMessage(payload, f"[*] 비정상 사용자 접근 확인 -> [{email}]", roomId_availability)
        return ("")
