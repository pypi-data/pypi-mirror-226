...
setup(**{
    ...
    'install_requires': (
        'aiodocker~=0.21.0',
        'aiohttp~=3.8.1',
        """backend.ai-agent==23.03.11
""",
        """backend.ai-cli==23.03.11
""",
        """backend.ai-common==23.03.11
""",
        """backend.ai-kernel-binary==23.03.11
""",
        """backend.ai-kernel-helper==23.03.11
""",
        """backend.ai-kernel==23.03.11
""",
