...
class LambdaExecutor:
    ...
    def execute(self, input_message):
        ...
        #     print('problem')
        #     log the problem to the dynamodb: it was problem w echopype, so allow pipeline to continue w/o this file
        # else:
        #
        ...
        #######################################################################
        self.__delete_all_local_raw_and_zarr_files()
        self.__s3.download_file(  # TODO: should pass credentials
