...
class Kubedev:
  ...
  def _run_docker_detached(
    ...
    file_accessor: object) -> Tuple[str, bool]:
      ...
      print(f'isFromKubedev: {isFromKubedev}')
      print(f'buildServiceContainer: {buildServiceContainer}')
      if isFromKubedev and buildServiceContainer:
          self.build_from_image(imageDef, "none", env_accessor, shell_executor)

      if not buildServiceContainer:
    ...
    file_accessor: object):
      ...
      cmdCreate = [
        ...
        " ".join([
          ...
          KubedevConfig.get_docker_run_devices_list(devices) + \
          additionalArgs + \
          [image] + cmd)]
  ...
  def system_test_from_config(self,
                              kubedev,
                              appName: str,
                              reuseCluster: str, 
                              buildServiceContainer: bool,
      ...
      try:
          ...
          startedContainers = [
              self._run_docker_detached(
                  ...
                  self._field_optional(service, 'devices', dict()),
