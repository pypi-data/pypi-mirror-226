...
function ProgressCircle(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { role: "progressbar", "aria-label": props.label || 'Unlabelled progress circle', "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": props.progress, style: { margin: 'auto' } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { viewBox: "0 0 250 250" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("circle", { cx: "125", cy: "125", r: `${radius}`, strokeWidth: "20", fill: "none", stroke: (_a = props.stroke) !== null && _a !== void 0 ? _a : 'var(--jp-inverse-layout-color2)' }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { transform: "translate(125,125) scale(.9)", d: d(props.progress), fill: (_b = props.stroke) !== null && _b !== void 0 ? _b : 'var(--jp-inverse-layout-color2)' }))));
}
...
function TopbarElement(props) {
    ...
    const themeSelect = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(() => {
        var _a;
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("select", { className: "voila-topbar-theme", onChange: onThemeChange, style: { color: (_a = config.textColor) !== null && _a !== void 0 ? _a : 'var(--jp-ui-font-color1)' } }, themeOptions.map(el => {
            var _a;
            return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("option", { key: el, value: el, style: {
                    background: (_a = config.background) !== null && _a !== void 0 ? _a : 'var(--jp-layout-color2)'
                } }, el));
        })));
    }, [themeOptions, onThemeChange, config.textColor, config.background]);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "voila-topbar", style: { background: (_a = config.background) !== null && _a !== void 0 ? _a : 'var(--jp-layout-color2)' } },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, config.icon && react__WEBPACK_IMPORTED_MODULE_0__.createElement("img", { style: { width: '50px' }, src: config.icon })),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "voila-topbar-title", style: { color: (_b = config.textColor) !== null && _b !== void 0 ? _b : 'var(--jp-ui-font-color1)' } }, config.title),
        themeSelect,
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_kernelStatus__WEBPACK_IMPORTED_MODULE_1__.ProgressCircle, { progress: kernelBusy, width: 50, height: 50, stroke: (_c = config.textColor) !== null && _c !== void 0 ? _c : 'var(--jp-ui-font-color1)' })));
}
...
//# sourceMappingURL=lib_index_js.d6508b7ab4d9b177a669.js.map