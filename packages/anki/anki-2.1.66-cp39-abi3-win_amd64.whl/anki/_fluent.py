...
You can help us complete this help page on {$link}. '''
    ...
    def importing_appeared_twice_in_file(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 7, {"val": val})
    ...
    def importing_cards_added(self, count: int) -> str:
        r''' {$count} cards added. '''
        return self._translate(20, 9, {"count": count})
    ...
    def importing_conflicting_notes_skipped(self, count: int) -> str:
        r''' {$count} were not imported, because their note type has changed. '''
    ...
    def importing_empty_first_field(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 17, {"val": val})
    ...
    def importing_existing_notes_skipped(self, count: int) -> str:
        ...
        return self._translate(20, 20, {"count": count})
    ...
    def importing_failed_to_import_media_file(self, debug_info: str) -> str:
        ...
        return self._translate(20, 23, {"debugInfo": debug_info})
    ...
    def importing_fields_separated_by(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 27, {"val": val})
    ...
    def importing_map_to(self, val: FluentVariable) -> str:
        r''' Map to {$val} '''
        return self._translate(20, 45, {"val": val})
    ...
    def importing_note_added(self, count: int) -> str:
        r''' {$count} notes added '''
        return self._translate(20, 53, {"count": count})


    def importing_note_imported(self, count: int) -> str:
        r''' {$count} notes imported. '''
        return self._translate(20, 54, {"count": count})
    ...
    def importing_notes_skipped_as_theyre_already_in(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 66, {"val": val})
    ...
    def importing_notes_skipped_update_due_to_notetype(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 67, {"val": val})
    ...
    def importing_notes_that_could_not_be_imported(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 68, {"val": val})
    ...
    def importing_notes_updated_as_file_had_newer(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 70, {"val": val})
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(20, 79, {"row": row, "found": found, "expected": expected})
    ...
    def importing_unable_to_import_filename(self, filename: str) -> str:
        ...
        return self._translate(20, 95, {"filename": filename})
...
class LegacyTranslationEnum:
    ...
    IMPORTING_ANKI_FILES_ARE_FROM_A_VERY = (20, 5)
    IMPORTING_ANKI2_FILES_ARE_NOT_DIRECTLY_IMPORTABLE = (20, 6)
    IMPORTING_APPEARED_TWICE_IN_FILE = (20, 7)
    IMPORTING_BY_DEFAULT_ANKI_WILL_DETECT_THE = (20, 8)
    IMPORTING_CARDS_ADDED = (20, 9)
    IMPORTING_CHANGE = (20, 10)
    IMPORTING_COLON = (20, 11)
    IMPORTING_COMMA = (20, 12)
    IMPORTING_CONFLICTING_NOTES_SKIPPED = (20, 13)
    IMPORTING_DETAILS = (20, 14)
    IMPORTING_DUPLICATE = (20, 15)
    IMPORTING_DUPLICATE_NOTE_ADDED = (20, 16)
    IMPORTING_EMPTY_FIRST_FIELD = (20, 17)
    IMPORTING_EXISTING_NOTE_SKIPPED = (20, 18)
    IMPORTING_EXISTING_NOTES = (20, 19)
    IMPORTING_EXISTING_NOTES_SKIPPED = (20, 20)
    IMPORTING_EXTRACTING = (20, 21)
    IMPORTING_FAILED_DEBUG_INFO = (20, 22)
    IMPORTING_FAILED_TO_IMPORT_MEDIA_FILE = (20, 23)
    IMPORTING_FIELD_MAPPING = (20, 24)
    IMPORTING_FIELD_OF_FILE_IS = (20, 25)
    IMPORTING_FIELD_SEPARATOR = (20, 26)
    IMPORTING_FIELDS_SEPARATED_BY = (20, 27)
    IMPORTING_FILE = (20, 28)
    IMPORTING_FILE_EMPTY = (20, 29)
    IMPORTING_FILE_MUST_CONTAIN_FIELD_COLUMN = (20, 30)
    IMPORTING_FILE_VERSION_UNKNOWN_TRYING_IMPORT_ANYWAY = (20, 31)
    IMPORTING_FIRST_FIELD_MATCHED = (20, 32)
    IMPORTING_GATHERING = (20, 33)
    IMPORTING_IDENTICAL = (20, 34)
    IMPORTING_IGNORE_FIELD = (20, 35)
    IMPORTING_IGNORE_LINES_WHERE_FIRST_FIELD_MATCHES = (20, 36)
    IMPORTING_IGNORED = (20, 37)
    IMPORTING_IMPORT_EVEN_IF_EXISTING_NOTE_HAS = (20, 38)
    IMPORTING_IMPORT_LOG = (20, 39)
    IMPORTING_IMPORT_OPTIONS = (20, 40)
    IMPORTING_IMPORTING_COLLECTION = (20, 41)
    IMPORTING_IMPORTING_COMPLETE = (20, 42)
    IMPORTING_IMPORTING_FILE = (20, 43)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (20, 44)
    IMPORTING_MAP_TO = (20, 45)
    IMPORTING_MAP_TO_TAGS = (20, 46)
    IMPORTING_MAPPED_TO = (20, 47)
    IMPORTING_MAPPED_TO_TAGS = (20, 48)
    IMPORTING_MATCH_SCOPE = (20, 49)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (20, 50)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (20, 51)
    IMPORTING_NO_NOTES_IN_FILE = (20, 52)
    IMPORTING_NOTE_ADDED = (20, 53)
    IMPORTING_NOTE_IMPORTED = (20, 54)
    IMPORTING_NOTE_SKIPPED_DUE_TO_EMPTY_FIRST_FIELD = (20, 55)
    IMPORTING_NOTE_SKIPPED_DUE_TO_MISSING_DECK = (20, 56)
    IMPORTING_NOTE_SKIPPED_DUE_TO_MISSING_NOTETYPE = (20, 57)
    IMPORTING_NOTE_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 58)
    IMPORTING_NOTE_UNCHANGED = (20, 59)
    IMPORTING_NOTE_UPDATED = (20, 60)
    IMPORTING_NOTE_UPDATED_AS_FILE_HAD_NEWER = (20, 61)
    IMPORTING_NOTES_ADDED = (20, 62)
    IMPORTING_NOTES_ADDED_FROM_FILE = (20, 63)
    IMPORTING_NOTES_FOUND_IN_FILE = (20, 64)
    IMPORTING_NOTES_FOUND_IN_FILE2 = (20, 65)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (20, 66)
    IMPORTING_NOTES_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 67)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (20, 68)
    IMPORTING_NOTES_UPDATED = (20, 69)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (20, 70)
    IMPORTING_NOTETYPE_AND_DECK = (20, 71)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (20, 72)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (20, 73)
    IMPORTING_PIPE = (20, 74)
    IMPORTING_PRESERVE = (20, 75)
    IMPORTING_PROCESSED_CARDS = (20, 76)
    IMPORTING_PROCESSED_MEDIA_FILE = (20, 77)
    IMPORTING_PROCESSED_NOTES = (20, 78)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (20, 79)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (20, 80)
    IMPORTING_SEMICOLON = (20, 81)
    IMPORTING_SHOW = (20, 82)
    IMPORTING_SKIPPED = (20, 83)
    IMPORTING_STATUS = (20, 84)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (20, 85)
    IMPORTING_TAB = (20, 86)
    IMPORTING_TAG_ALL_NOTES = (20, 87)
    IMPORTING_TAG_MODIFIED_NOTES = (20, 88)
    IMPORTING_TAG_UPDATED_NOTES = (20, 89)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (20, 90)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (20, 91)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (20, 92)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (20, 93)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (20, 94)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (20, 95)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (20, 96)
    IMPORTING_UNKNOWN_FILE_FORMAT = (20, 97)
    IMPORTING_UPDATE = (20, 98)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (20, 99)
    IMPORTING_UPDATED = (20, 100)
    KEYBOARD_CTRL = (21, 0)
    KEYBOARD_SHIFT = (21, 1)
    ...
    NOTETYPES_NOTE_TYPES = (25, 33)
    NOTETYPES_NOTETYPE = (25, 34)
    NOTETYPES_OCCLUSION = (25, 35)
    NOTETYPES_OCCLUSION_MASK = (25, 36)
    NOTETYPES_OCCLUSION_NOTE = (25, 37)
    NOTETYPES_OPTIONS = (25, 38)
    NOTETYPES_PLEASE_ADD_ANOTHER_NOTE_TYPE_FIRST = (25, 39)
    NOTETYPES_TEXT_FIELD = (25, 40)
    NOTETYPES_TOGGLE_MASKS = (25, 41)
    NOTETYPES_TYPE = (25, 42)
