...
class Notetype(google.protobuf.message.Message):
    ...
    class Config(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["css", b"css", "kind", b"kind", "latex_post", b"latex_post", "latex_pre", b"latex_pre", "latex_svg", b"latex_svg", "original_stock_kind", b"original_stock_kind", "other", b"other", "reqs", b"reqs", "sort_field_idx", b"sort_field_idx", "target_deck_id_unused", b"target_deck_id_unused"]) -> None: ...
