...
class MergeValidator(MergeHandler):
    ...
    def validate_base_state(self, basic_state, convograph) -> None:
        ...
        if basic_state.name == "stop":
            ...
            trigger = basic_state.triggers[0]
            trigger_state = convograph.find_state(name=trigger.state_name)
            is_trigger_valid_default = (
                trigger.is_default() and trigger_state.name == "start"
            )
        ...
        for trigger in basic_state.triggers:
            ...
            while (
                ...
                target_state = convograph.find_state(
                    name=target_state.triggers[0].state_name
                )
