...
def akhdefo_dashApp(directory="", DEM_Path='', std_thresh_interpolation=1.0, port=8051, smoothing=False, hillshade_option=True):
        ...
        html.Div([
            html.Div([
                html.Div([
                    dcc.RadioItems(
                        id='selection-type2',
                        options=[{'label': i, 'value': i} for i in ['Mean-Deformation', 'Annual-Velocity']],
