...
from apoli_python_extension.blocks import *
            ...
            for key, value in power.items():
                if key != "type":
                    if key == "from" or key == "to" or key == "class":
                        key += "_value"
                    try:
                        value_type = value["type"].__name__.replace("apoli_python_extension.", "")
                    except AttributeError as e:
                        value_type = str(value["type"]).replace("blocks.", "").replace("typing.", "").replace("apoli_python_extension.", "")
