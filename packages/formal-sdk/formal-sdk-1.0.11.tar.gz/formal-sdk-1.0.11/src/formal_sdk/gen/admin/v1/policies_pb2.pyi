...
class DryRunPoliciesRequest(_message.Message):
    __slots__ = ["policy_rule_type", "application_name", "client_ip_address", "client_tls", "statement_type", "db_name", "schema_paths", "table_paths", "column_tags", "column_name", "column_path", "data_label", "sidecar_id", "aws", "columns"]
