...
class WorkspaceSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_pod_compute_resources", b"client_pod_compute_resources", "image_id", b"image_id", "tags", b"tags", "workspace_name", b"workspace_name"]) -> None: ...
