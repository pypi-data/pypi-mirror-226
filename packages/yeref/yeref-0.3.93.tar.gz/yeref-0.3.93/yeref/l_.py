...
l_show_settings = {
    'ru': "⚙️ <b>Выбери</b> опцию для <i>настройки</i> /cmd <b>{0}</b>",
    'en': "⚙️ <b>Choose</b> option for <i>settings</i> /cmd <b>{0}</b>",
    'es': "⚙️ <b>Elegir</b> opción para <i>configuración</i> /cmd <b>{0}</b>",
    'fr': "⚙️ <b>Choisir</b> l'option pour les <i>paramètres</i> /cmd <b>{0}</b>",
    'zh': "⚙️ <i>設置</i> /cmd <b>{0}</b> 的<b>選擇</b>選項",
    'ar': "⚙️ <b> اختر </b> خيار <i> الإعدادات </i> /cmd <b>{0}</b>",
}
...
l_parse_done = {
    'ru': "🔥 Готово! Для <code>{0}</code> собрано реальных <b>{1}</b>-участников: <u>{2}</u>{3}\n\n👩🏽‍💻 Для рассылки и инвайта можно использовать @ferey_send_bot",
    'en': "🔥 Готово! For <code>{0}</code> gathered real members <b>{1}</b>: <u>{2}</u>{3}\n\n👩🏽‍💻 For sending and invite please use @ferey_send_bot",
    ...
    'fr': "🔥 Prêt ! Membres réunis : <u>{0}</u>. Vous pouvez immédiatement faire un <b>envoi</b> ou <b>inviter</b> pour accounter par membres reçus{1}",
...
l_cinvite_csv_table = {
    'ru': "📨️ В csv-файле @username или ссылка должны быть в 3м столбце",
    'en': "📨️ In csv-file @username or link have to be at 3rd columns",
...
l_cinvite_csv_file = {
    'ru': "📨️ Пришли корректный текстовый <b>файл</b> со списком @username",
    'en': "📨️ Send correct text-<b>file</b> with @username-list",
    'es': "📨️ Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "📨️ Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "📨️ 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_correct_link = {
    'ru': "▪️ Вставь корректную ссылку или повтори операцию",
    'en': "▪️ Send correct link or try again later",
    'es': "▪️ Envíe el enlace correcto o vuelva a intentarlo más tarde",
    'fr': "▪️ Envoyez le lien correct ou réessayez plus tard",
    'zh': "▪️ 發送正確的鏈接或稍後再試",
    'ar': "▪️ أرسل الرابط الصحيح أو حاول مرة أخرى لاحقًا",
}
