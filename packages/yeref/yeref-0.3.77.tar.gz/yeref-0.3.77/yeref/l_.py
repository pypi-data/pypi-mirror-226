...
l_cneuro_media = {
    'ru': "🦾 1. <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> генерацию фото на основе постов/описания/контента в <b>{0}</b>\n\n👩🏽‍💻 <b>Напиши</b> экстра-промпт, если необходимо\n\n(<i>жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "☑️☐Off incoming translation",
    'es': "☑️☐Traducción entrante desactivada",
    'fr': "☑️☐Désactiver la traduction entrante",
    'zh': "☑️☐关闭传入翻译",
...
l_cneuro_caption = {
    'ru': "🦾 2. <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> генерацию <u>текста</u> на основе описания и контента <b>{0}</b>\n\n👩🏽‍💻 <b>Напиши</b> экстра-промпт, если необходимо\n\n(<i>жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "☑️☐Off incoming translation",
    'es': "☑️☐Traducción entrante desactivada",
    'fr': "☑️☐Désactiver la traduction entrante",
    'zh': "☑️☐关闭传入翻译",
