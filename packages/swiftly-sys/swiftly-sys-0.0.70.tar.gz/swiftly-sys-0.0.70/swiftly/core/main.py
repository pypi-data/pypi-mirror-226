...
def init(name=None, runtime=None, frameworks=None):
...
def makealive():
    ...
    init(project_name, runtime, frameworks)  # Use 'runtime' here instead of 'detected_runtimes'
