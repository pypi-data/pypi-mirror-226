...
def makeapp(name=None):
    """Create a new app."""
    # Get runtime and frameworks (assuming functions get_runtime() and get_frameworks() exist)
    ...
    # You can now execute commands based on the executionList or use it as needed.
