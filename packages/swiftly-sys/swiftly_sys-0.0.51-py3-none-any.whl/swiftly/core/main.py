...
def init(name=None):
    ...
    runtimes = [d for d in os.listdir(runtime_dir) if os.path.isdir(os.path.join(runtime_dir, d))]
    ...
    available_frameworks = [d for d in os.listdir(framework_dir) if os.path.isdir(os.path.join(framework_dir, d))]
