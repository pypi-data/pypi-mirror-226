...
def init(name=None):
    ...
    # Change directory and list available runtimes
    os.chdir("../runtime")
    runtimes = os.listdir()
    ...
    # Change directory and list available frameworks for the selected runtime
    os.chdir(f"../{runtime}/frameworks")
    available_frameworks = os.listdir()
