...
class OrmPipelineStepExecutionEdges(object):
    ...
    def __init__(self, access_token=None, execution=None, run_execution=None, step_spec=None, triggering_pipeline_execution=None, workload=None, local_vars_configuration=None):  # noqa: E501
