...
class OrmPipelineExecution(object):
    ...
    def __init__(self, arguments=None, created_dt=None, edges=None, end_dt=None, id=None, immutable_slug=None, number=None, output_variables=None, pipeline_id=None, pipeline_spec_id=None, reason=None, status=None, triggered_user_id=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
