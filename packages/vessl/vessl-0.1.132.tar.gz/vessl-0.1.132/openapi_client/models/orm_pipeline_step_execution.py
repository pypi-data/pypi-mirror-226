...
class OrmPipelineStepExecution(object):
    ...
    def __init__(self, context=None, created_dt=None, edges=None, external_service_endpoint=None, id=None, immutable_slug=None, judgment_by=None, judgment_dt=None, pipeline_execution_id=None, status=None, step_id=None, step_spec_id=None, step_type=None, triggering_pipeline_execution_id=None, updated_dt=None, variables=None, local_vars_configuration=None):  # noqa: E501
