...
class OrmModelEdges(object):
    ...
    def __init__(self, artifact_volume=None, created_by=None, experiment=None, model_generated_experiments=None, model_repository=None, tags=None, local_vars_configuration=None):  # noqa: E501
