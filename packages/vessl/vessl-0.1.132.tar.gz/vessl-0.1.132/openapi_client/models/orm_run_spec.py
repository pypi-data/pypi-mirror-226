...
class OrmRunSpec(object):
    ...
    def __init__(self, cluster_id=None, created_dt=None, description=None, edges=None, id=None, image_id=None, immutable_slug=None, project_id=None, resource_spec_preset_id=None, spec=None, title=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
