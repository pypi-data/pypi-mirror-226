...
class ResponseProjectInfo(object):
    ...
    def __init__(self, created_dt=None, description=None, experiment_summary=None, id=None, is_example=None, key_metrics=None, name=None, note=None, organization=None, primary_owner=None, project_datasets=None, project_repositories=None, updated_dt=None, volume_id=None, local_vars_configuration=None):  # noqa: E501
