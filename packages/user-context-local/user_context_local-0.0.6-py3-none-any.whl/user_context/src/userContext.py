...
class UserContext:
    ...
    def set_jwt_token(self,jwt_token:str)->None:
        try:
            ...
            self.profile_id = int(decoded_payload.get('profileId'))  # Use 'profileId' instead of 'profile_id'
            self.user_id = int(decoded_payload.get('userId'))  # Use 'userId' instead of 'user_id'
