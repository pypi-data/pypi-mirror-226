...
class ClobPair(_message.Message):
    __slots__ = ["id", "perpetual_clob_metadata", "spot_clob_metadata", "step_base_quantums", "subticks_per_tick", "quantum_conversion_exponent", "min_order_base_quantums", "status", "maker_fee_ppm", "taker_fee_ppm"]
    ...
    MIN_ORDER_BASE_QUANTUMS_FIELD_NUMBER: _ClassVar[int]
    ...
    maker_fee_ppm: int
    taker_fee_ppm: int
    def __init__(self, id: _Optional[int] = ..., perpetual_clob_metadata: _Optional[_Union[PerpetualClobMetadata, _Mapping]] = ..., spot_clob_metadata: _Optional[_Union[SpotClobMetadata, _Mapping]] = ..., step_base_quantums: _Optional[int] = ..., subticks_per_tick: _Optional[int] = ..., quantum_conversion_exponent: _Optional[int] = ..., min_order_base_quantums: _Optional[int] = ..., status: _Optional[_Union[ClobPair.Status, str]] = ..., maker_fee_ppm: _Optional[int] = ..., taker_fee_ppm: _Optional[int] = ...) -> None: ...
