...
class IndexerTendermintEvent(_message.Message):
    __slots__ = ["subtype", "data", "transaction_index", "block_event", "event_index"]
    ...
    event_index: int
    def __init__(self, subtype: _Optional[str] = ..., data: _Optional[str] = ..., transaction_index: _Optional[int] = ..., block_event: _Optional[_Union[IndexerTendermintEvent.BlockEvent, str]] = ..., event_index: _Optional[int] = ...) -> None: ...
