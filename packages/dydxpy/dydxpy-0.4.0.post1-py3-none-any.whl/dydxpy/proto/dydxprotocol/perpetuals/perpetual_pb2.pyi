...
class Perpetual(_message.Message):
    __slots__ = ["id", "ticker", "market_id", "atomic_resolution", "default_funding_ppm", "liquidity_tier", "funding_index", "open_interest"]
    ...
    funding_index: bytes
    open_interest: int
    def __init__(self, id: _Optional[int] = ..., ticker: _Optional[str] = ..., market_id: _Optional[int] = ..., atomic_resolution: _Optional[int] = ..., default_funding_ppm: _Optional[int] = ..., liquidity_tier: _Optional[int] = ..., funding_index: _Optional[bytes] = ..., open_interest: _Optional[int] = ...) -> None: ...
