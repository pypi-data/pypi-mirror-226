...
def recon_table_to_str(Ts, df_recs, orthogroup_column= 'OG'):
    ...
    df_r= pd.DataFrame(dict(gene_tree= df_recs.reconciliated_tree.apply( lambda x: get_nhx(x, name_attr= 'accession') ),
    ...
    return df_r[[orthogroup_column, 'gene_tree', 'reconciliation_map', 'flipped_nodes']]
