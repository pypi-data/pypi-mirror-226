...
from macrometa_source_mysql.sync_strategies import full_table
from macrometa_source_mysql.sync_strategies import incremental
from sample_data import fetch_samples, modify_reserved_keys
from sync_strategies import log_based
            ...
            with connect_with_backoff(mysql_conn) as open_conn:
                try:
                    with open_conn.cursor() as cur:
                        ...
                        cur.execute("SHOW TABLES FROM %s LIKE %s", (database_name, table_name))
