...
file1='/sps/lsst/users/tguillem/web/clusters/catalogs/cosmoDC2_small_photoz_flexzboost/v1/9559/galaxies.fits'
file2='/sps/lsst/users/tguillem/web/clusters/catalogs/cosmoDC2_small_photoz_flexzboost/v1/9554/galaxies.fits'
galaxy_data1 = Table.read(file)
print(galaxy_data)



fig = plt.figure(figsize=(12,8))
plt.hist(galaxy_data['redshift'], density=False,range = (0, 3), bins = 60, label="redshift", histtype='step', color = 'black');
...
plt.legend(title = 'cosmoDC2 FlexZBoost validation', loc='upper right')
outpath = "/sps/lsst/users/tguillem/web/clusters/debug/"
plt.savefig(outpath+"redshift_v0.png", bbox_inches='tight')
plt.close()
sys.exit()
