...
from requestspro import compat
from requestspro._internal_utils import unicode_is_ascii
from requestspro.cookies import RequestsCookieJar
from requestspro.structures import CaseInsensitiveDict
from requestspro.utils import (
...
class TestGetEnvironProxies:
    ...
    def test_bypass_no_proxy_keyword(self, url):
        no_proxy = "192.168.1.1,requestspro.com"
...
def test_should_bypass_proxies_pass_only_hostname(url, expected, mocker):
    ...
    """
    proxy_bypass = mocker.patch("requestspro.utils.proxy_bypass")
